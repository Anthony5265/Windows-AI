...
Publish `mobile/docs/offline-mode.md` describing cache policies for disconnected usage.
...
This document provides comprehensive information about offline mode.
