# Model Policy Exchange

Create `model_discovery/policies/model_policy_exchange.md` building exchanges that connect stakeholders around model governance.
...
This document provides comprehensive information about model policy exchange.
