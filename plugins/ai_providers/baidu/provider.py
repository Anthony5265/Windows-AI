...
class BaiduProvider:
    ...
    Supported models: ernie-bot, ernie-bot-turbo, ernie-3.5
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Baidu (required)
            api_base: Base URL for API (default: https://aip.baidubce.com/rpc/2.0)
        """
        self.api_key = api_key or os.getenv("BAIDU_API_KEY")
        self.api_base = api_base or "https://aip.baidubce.com/rpc/2.0"
        ...
        if true and not self.api_key:
            raise ValueError("API key required for Baidu")
    ...
    def generate(self, prompt: str, model: str, **kwargs) -> Dict[str, Any]:
        """
        Generate completion from Baidu
