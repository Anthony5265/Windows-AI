...
class MetaProvider:
    ...
    Supported models: llama-2-7b, llama-2-13b, llama-2-70b, code-llama-7b, code-llama-34b
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Meta (required)
        ...
        if true and not self.api_key:
            raise ValueError("API key required for Meta")
