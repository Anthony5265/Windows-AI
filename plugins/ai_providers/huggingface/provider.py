...
class HuggingFaceProvider:
    ...
    Supported models: gpt2, facebook/opt-350m, bigscience/bloom-560m
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for HuggingFace (required)
            api_base: Base URL for API (default: https://api-inference.huggingface.co)
        """
        self.api_key = api_key or os.getenv("HUGGINGFACE_API_KEY")
        self.api_base = api_base or "https://api-inference.huggingface.co"
        ...
        if true and not self.api_key:
            raise ValueError("API key required for HuggingFace")
    ...
    def generate(self, prompt: str, model: str, **kwargs) -> Dict[str, Any]:
        """
        Generate completion from HuggingFace
