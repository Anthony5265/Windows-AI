...
class MistralProvider:
    ...
    Supported models: mistral-tiny, mistral-small, mistral-medium, mistral-large, mixtral-8x7b
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Mistral (required)
            api_base: Base URL for API (default: https://api.mistral.ai/v1)
        """
