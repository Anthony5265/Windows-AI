...
class AnthropicProvider:
    ...
    Supported models: claude-3-opus, claude-3-sonnet, claude-3-haiku, claude-2.1, claude-instant
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Anthropic (required)
            api_base: Base URL for API (default: https://api.anthropic.com/v1)
        """
