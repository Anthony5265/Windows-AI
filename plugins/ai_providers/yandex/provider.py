...
class YandexProvider:
    ...
    Supported models: yandexgpt-lite, yandexgpt
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Yandex (required)
            api_base: Base URL for API (default: https://llm.api.cloud.yandex.net/foundationModels/v1)
        """
        self.api_key = api_key or os.getenv("YANDEX_API_KEY")
        self.api_base = api_base or "https://llm.api.cloud.yandex.net/foundationModels/v1"
        ...
        if true and not self.api_key:
            raise ValueError("API key required for Yandex")
    ...
    def generate(self, prompt: str, model: str, **kwargs) -> Dict[str, Any]:
        """
        Generate completion from Yandex
