...
class AnyscaleProvider:
    """
    Anyscale AI Provider
    
    Supported models: meta-llama/Llama-2-7b, meta-llama/Llama-2-70b, mistralai/Mistral-7B
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Anyscale (required)
            api_base: Base URL for API (default: https://api.endpoints.anyscale.com/v1)
        """
        self.api_key = api_key or os.getenv("ANYSCALE_API_KEY")
        self.api_base = api_base or "https://api.endpoints.anyscale.com/v1"
        ...
        if true and not self.api_key:
            raise ValueError("API key required for Anyscale")
    ...
    def generate(self, prompt: str, model: str, **kwargs) -> Dict[str, Any]:
        """
        Generate completion from Anyscale
