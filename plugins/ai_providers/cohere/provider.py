...
class CohereProvider:
    ...
    Supported models: command, command-light, command-nightly, embed-english, embed-multilingual
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Cohere (required)
            api_base: Base URL for API (default: https://api.cohere.ai/v1)
        """
