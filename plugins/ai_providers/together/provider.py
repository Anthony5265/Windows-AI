...
class TogetherProvider:
    ...
    Supported models: togethercomputer/RedPajama-INCITE-7B, togethercomputer/falcon-40b, togethercomputer/mpt-30b
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Together (required)
            api_base: Base URL for API (default: https://api.together.xyz/v1)
        """
        ...
        if true and not self.api_key:
            raise ValueError("API key required for Together")
    ...
    def generate(self, prompt: str, model: str, **kwargs) -> Dict[str, Any]:
        """
        Generate completion from Together
