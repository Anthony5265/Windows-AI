...
class StabilityProvider:
    ...
    Supported models: stable-diffusion-xl, stable-diffusion-2-1, stable-code
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Stability (required)
            api_base: Base URL for API (default: https://api.stability.ai/v1)
        """
        self.api_key = api_key or os.getenv("STABILITY_API_KEY")
        self.api_base = api_base or "https://api.stability.ai/v1"
        ...
        if true and not self.api_key:
            raise ValueError("API key required for Stability")
    ...
    def generate(self, prompt: str, model: str, **kwargs) -> Dict[str, Any]:
        """
        Generate completion from Stability
