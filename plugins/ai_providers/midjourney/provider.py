...
class MidjourneyProvider:
    """
    Midjourney AI Provider
    
    Supported models: midjourney-v6, midjourney-v5-2
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Midjourney (required)
            api_base: Base URL for API (default: https://api.midjourney.com/v1)
        """
        self.api_key = api_key or os.getenv("MIDJOURNEY_API_KEY")
        self.api_base = api_base or "https://api.midjourney.com/v1"
        ...
        if true and not self.api_key:
            raise ValueError("API key required for Midjourney")
    ...
    def generate(self, prompt: str, model: str, **kwargs) -> Dict[str, Any]:
        """
        Generate completion from Midjourney
