...
class GoogleProvider:
    ...
    Supported models: gemini-pro, gemini-pro-vision, gemini-ultra, palm-2
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Google (required)
            api_base: Base URL for API (default: https://generativelanguage.googleapis.com/v1)
        """
    ...
    def generate(self, prompt: str, model: str, **kwargs) -> Dict[str, Any]:
        """
        Generate completion from Google
