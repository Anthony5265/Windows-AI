...
Introduce `plugins/docs/versioning-policy.md` ensuring compatibility commitments.
...
This document provides comprehensive information about versioning policy.
