...
Provide `plugins/marketplace/payments_integration.md` guiding monetization options.
...
This document provides comprehensive information about payments integration.
