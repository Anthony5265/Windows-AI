# Plugins Marketplace Brief

Build `plugins/marketplace/plugins_marketplace_brief.md` issuing briefs that communicate the state of marketplace growth.
...
This document provides comprehensive information about plugins marketplace brief.
