# Text Generation WebUI Platform
...
```python
from plugins.local_models.text_generation_webui import TextGenerationWebUIPlatform
...
- **Port:** 7860
- **Models Directory:** ~/text-generation-webui/models
- **Executable:** python
