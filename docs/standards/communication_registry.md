...
Document `docs/standards/communication_registry.md` maintaining a registry of owners responsible for team communication rituals.
...
This document provides comprehensive information about communication registry.
