...
Build `docs/standards/communication_notebook.md` curating exploratory notebooks that showcase team communication rituals best practices.
...
This document provides comprehensive information about communication notebook.
