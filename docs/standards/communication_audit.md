...
Add `docs/standards/communication_audit.md` delivering recurring audits for team communication rituals across services.
...
This document provides comprehensive information about communication audit.
