...
Publish `docs/standards/communication_matrix.md` mapping team communication rituals coverage across foundational modules.
...
This document provides comprehensive information about communication matrix.
