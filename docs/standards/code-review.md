...
Ship `docs/standards/code-review.md` enumerating review expectations for foundational modules.
...
This document provides comprehensive information about code review.
