...
Create `docs/architecture/architecture_scorecard.md` summarizing architecture governance progress against roadmap targets.
...
This document provides comprehensive information about architecture scorecard.
