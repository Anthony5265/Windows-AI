...
Introduce `scripts/dev/prep-offline-install.ps1` packaging dependencies for air-gapped installs.
...
This document provides comprehensive information about file conventions.
