...
Add `docs/architecture/event-bus.md` explaining message routing between orchestration components.
...
This document provides comprehensive information about event bus.
