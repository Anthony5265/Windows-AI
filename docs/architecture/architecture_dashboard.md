...
Introduce `docs/architecture/architecture_dashboard.md` providing live dashboards that surface architecture governance status in real time.
...
This document provides comprehensive information about architecture dashboard.
