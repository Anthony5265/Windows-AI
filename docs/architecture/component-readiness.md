...
Publish `docs/architecture/component-readiness.md` grading each foundational service's maturity.
...
This document provides comprehensive information about component readiness.
