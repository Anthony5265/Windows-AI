...
Publish `docs/architecture/service-boundaries.md` clarifying microservice responsibilities and data flows.
...
This document provides comprehensive information about service boundaries.
