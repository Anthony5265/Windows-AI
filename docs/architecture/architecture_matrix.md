...
Publish `docs/architecture/architecture_matrix.md` mapping architecture governance coverage across foundational modules.
...
This document provides comprehensive information about architecture matrix.
