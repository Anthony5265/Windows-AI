...
Document `docs/architecture/architecture_registry.md` maintaining a registry of owners responsible for architecture governance.
...
This document provides comprehensive information about architecture registry.
