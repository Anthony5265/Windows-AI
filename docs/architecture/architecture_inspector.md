...
Ship `docs/architecture/architecture_inspector.md` automating inspections that verify architecture governance before merges.
...
This document provides comprehensive information about architecture inspector.
