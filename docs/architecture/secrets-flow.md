...
Create `docs/architecture/secrets-flow.md` mapping how secrets travel across foundational components.
...
This document provides comprehensive information about secrets flow.
