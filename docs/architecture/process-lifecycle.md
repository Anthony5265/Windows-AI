...
Introduce `scripts/dev/generate-openapi.ps1` to regenerate API contracts whenever handlers change.
...
This document provides comprehensive information about process lifecycle.
