...
Provide `docs/architecture/configuration-hierarchy.md` explaining precedence across config files.
...
This document provides comprehensive information about configuration hierarchy.
