...
Add `docs/architecture/component-registry.md` listing every service, module owner, and escalation contact.
...
This document provides comprehensive information about component registry.
