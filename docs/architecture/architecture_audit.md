...
Add `docs/architecture/architecture_audit.md` delivering recurring audits for architecture governance across services.
...
This document provides comprehensive information about architecture audit.
