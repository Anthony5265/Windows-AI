...
Provide `docs/architecture/data-flow.md` describing how information travels between modules.
...
This document provides comprehensive information about data flow.
