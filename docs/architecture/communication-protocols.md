...
Publish `docs/architecture/communication-protocols.md` enumerating protocols between services.
...
This document provides comprehensive information about communication protocols.
