...
Provide `docs/security/supply-chain.md` detailing mitigations for dependency supply-chain risks.
...
This document provides comprehensive information about supply chain.
