...
Ship `docs/security/security_inspector.md` automating inspections that verify foundational security posture before merges.
...
This document provides comprehensive information about security inspector.
