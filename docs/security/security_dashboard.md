...
Introduce `docs/security/security_dashboard.md` providing live dashboards that surface foundational security posture status in real time.
...
This document provides comprehensive information about security dashboard.
