...
Add `security/hardening/windows_firewall_rules.ps1` for recommended firewall settings.
...
This document provides comprehensive information about penetration testing checklist.
