...
Implement `tests/regression/windows_build_validation.ps1` verifying packaging output.
...
This document provides comprehensive information about binary hardening.
