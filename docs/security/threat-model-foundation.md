...
Publish `docs/security/threat-model-foundation.md` capturing threats relevant to the base architecture.
...
This document provides comprehensive information about threat model foundation.
