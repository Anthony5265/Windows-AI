...
Provide `docs/security/red-team-ready.md` prepping environment for red-team exercises.
...
This document provides comprehensive information about red team ready.
