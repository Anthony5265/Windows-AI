...
Publish `docs/security/security_matrix.md` mapping foundational security posture coverage across foundational modules.
...
This document provides comprehensive information about security matrix.
