# Docs Security Telemetry

Deliver `docs/security/docs_security_telemetry.md` expanding telemetry streams that observe security operations.
...
This document provides comprehensive information about docs security telemetry.
