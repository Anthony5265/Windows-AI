...
Create `docs/security/security_scorecard.md` summarizing foundational security posture progress against roadmap targets.
...
This document provides comprehensive information about security scorecard.
