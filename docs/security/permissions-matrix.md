...
Publish `docs/security/permissions-matrix.md` mapping required privileges per service.
...
This document provides comprehensive information about permissions matrix.
