...
The control center provides contextual tooltips and multi-step walkthroughs.
These aids highlight important controls and guide users through common tasks
such as connecting to model backends or enabling search.
...
@@ -76,30 +82,28 @@ if __name__ == '__main__':
