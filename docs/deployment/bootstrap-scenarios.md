...
Add `scripts/dev/run-docker-compose.ps1` to orchestrate backend containers for Windows-based development.
...
This document provides comprehensive information about bootstrap scenarios.
