...
Provide `docs/deployment/offline_installer.md` covering offline distribution packaging.
...
This document provides comprehensive information about offline installer.
