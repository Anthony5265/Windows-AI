...
Provide `docs/deployment/update-channel.md` describing update channels and policies.
...
This document provides comprehensive information about update channel.
