...
Provide `docs/deployment/windows-service-install.md` showing how to install as a service.
...
This document provides comprehensive information about windows service install.
