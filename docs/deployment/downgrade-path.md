...
Provide `docs/deployment/downgrade-path.md` describing supported downgrade procedures.
...
This document provides comprehensive information about downgrade path.
