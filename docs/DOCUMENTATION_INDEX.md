# Windows AI Documentation Index

Complete documentation for Windows AI - your comprehensive AI platform for Windows.
...
### Operations
- [Build Instructions](deployment/BUILD.md) - Building from source
