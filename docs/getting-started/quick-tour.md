...
Publish onboarding walkthrough videos referenced from `docs/getting-started/quick-tour.md` for new developers.
...
This document provides comprehensive information about quick tour.
