...
Publish `docs/guides/cli-usage.md` demonstrating usage of the core CLI for development tasks.
...
This document provides comprehensive information about cli usage.
