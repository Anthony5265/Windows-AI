...
Publish `docs/guides/device-hand-off.md` outlining how tasks migrate between desktop and mobile experiences.
...
This document provides comprehensive information about device hand off.
