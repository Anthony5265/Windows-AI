...
Publish `docs/guides/automation-api.md` explaining how external tools trigger workflows via HTTP.
...
This document provides comprehensive information about automation api.
