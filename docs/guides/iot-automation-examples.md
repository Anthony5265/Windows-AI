...
Publish `docs/guides/iot-automation-examples.md` describing sample device orchestration flows.
...
This document provides comprehensive information about iot automation examples.
