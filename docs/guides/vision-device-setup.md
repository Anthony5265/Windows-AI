...
Publish `docs/guides/vision-device-setup.md` to calibrate webcams for screen understanding.
...
This document provides comprehensive information about vision device setup.
