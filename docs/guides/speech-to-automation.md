...
Publish `docs/guides/speech-to-automation.md` linking voice commands to workflow templates.
...
This document provides comprehensive information about speech to automation.
