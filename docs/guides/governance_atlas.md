...
Implement `docs/guides/governance_atlas.md` mapping the signal flows that sustain context governance.
...
This document provides comprehensive information about governance atlas.
