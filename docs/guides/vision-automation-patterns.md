# Vision Automation Patterns

Publish `docs/guides/vision-automation-patterns.md` sharing common automation flows using screen context.
...
This document provides comprehensive information about vision automation patterns.
