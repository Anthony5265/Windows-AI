...
Build `docs/guides/governance_canvas.md` providing canvases where people can refine context governance.
...
This document provides comprehensive information about governance canvas.
