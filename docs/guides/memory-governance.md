...
Publish `docs/guides/memory-governance.md` covering retention policies and user controls.
...
This document provides comprehensive information about memory governance.
