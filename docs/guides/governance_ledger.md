...
Deliver `docs/guides/governance_ledger.md` recording decisions that influence context governance.
...
This document provides comprehensive information about governance ledger.
