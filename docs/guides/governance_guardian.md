...
Introduce `docs/guides/governance_guardian.md` guarding critical pathways that protect context governance.
...
This document provides comprehensive information about governance guardian.
