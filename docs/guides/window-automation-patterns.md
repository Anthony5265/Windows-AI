# Window Automation Patterns

Publish `docs/guides/window-automation-patterns.md` covering best practices for window manipulation.
...
This document provides comprehensive information about window automation patterns.
