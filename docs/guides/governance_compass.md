...
Ship `docs/guides/governance_compass.md` acting as a compass so teams can navigate context governance.
...
This document provides comprehensive information about governance compass.
