...
Publish `docs/guides/context-management.md` summarizing how memory layers interact.
...
This document provides comprehensive information about context management.
