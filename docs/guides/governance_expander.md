...
Add `docs/guides/governance_expander.md` expanding instrumentation that accelerates context governance.
...
This document provides comprehensive information about governance expander.
