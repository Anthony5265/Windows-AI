...
Provide `docs/observability/observability_handbook.md` offering a handbook so contributors internalize foundational observability.
...
This document provides comprehensive information about observability handbook.
