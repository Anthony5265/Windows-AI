...
Introduce `docs/observability/observability_dashboard.md` providing live dashboards that surface foundational observability status in real time.
...
This document provides comprehensive information about observability dashboard.
