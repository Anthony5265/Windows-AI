...
Publish `docs/observability/observability_matrix.md` mapping foundational observability coverage across foundational modules.
...
This document provides comprehensive information about observability matrix.
