# Docs Ecosystem Exchange

Create `docs/ecosystem/docs_ecosystem_exchange.md` building exchanges that connect stakeholders around ecosystem knowledge.
...
This document provides comprehensive information about docs ecosystem exchange.
