# Docs Ecosystem Brief

Build `docs/ecosystem/docs_ecosystem_brief.md` issuing briefs that communicate the state of ecosystem knowledge.
...
This document provides comprehensive information about docs ecosystem brief.
