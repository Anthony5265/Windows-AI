...
Ship `docs/testing/testing_inspector.md` automating inspections that verify baseline testing discipline before merges.
...
This document provides comprehensive information about testing inspector.
