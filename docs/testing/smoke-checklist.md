...
Publish `docs/testing/smoke-checklist.md` describing manual smoke tests for new integrations.
...
This document provides comprehensive information about smoke checklist.
