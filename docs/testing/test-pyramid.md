...
Provide `docs/testing/test-pyramid.md` aligning testing expectations between backend and frontend teams.
...
This document provides comprehensive information about test pyramid.
