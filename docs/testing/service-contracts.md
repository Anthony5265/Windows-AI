...
Provide `docs/testing/service-contracts.md` outlining API contracts validated during integration tests.
...
This document provides comprehensive information about service contracts.
