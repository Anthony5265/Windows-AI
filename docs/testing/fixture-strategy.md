...
Publish `docs/testing/fixture-strategy.md` defining shared fixtures across Python and Node test suites.
...
This document provides comprehensive information about fixture strategy.
