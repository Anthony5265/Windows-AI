...
Create `docs/testing/performance-baselines.md` capturing baseline metrics for core services.
...
This document provides comprehensive information about performance baselines.
