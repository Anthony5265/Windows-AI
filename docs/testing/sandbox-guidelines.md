...
Provide `docs/testing/sandbox-guidelines.md` for experiments within the foundational environment.
...
This document provides comprehensive information about sandbox guidelines.
