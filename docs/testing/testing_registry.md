...
Document `docs/testing/testing_registry.md` maintaining a registry of owners responsible for baseline testing discipline.
...
This document provides comprehensive information about testing registry.
