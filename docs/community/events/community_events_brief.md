# Community Events Brief

Build `community/events/community_events_brief.md` issuing briefs that communicate the state of event programming.
...
This document provides comprehensive information about community events brief.
