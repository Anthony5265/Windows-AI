...
Launch `community/events/community_events_dashboard.md` shipping dashboards that visualize event programming.
...
This document provides comprehensive information about community events dashboard.
