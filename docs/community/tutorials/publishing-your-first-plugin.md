...
Ship `community/tutorials/publishing-your-first-plugin.md` guiding first-time publishers.
...
This document provides comprehensive information about publishing your first plugin.
