...
Ship `docs/operations/operations_inspector.md` automating inspections that verify operations readiness before merges.
...
This document provides comprehensive information about operations inspector.
