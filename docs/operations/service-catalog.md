...
Provide `docs/operations/service-catalog.md` mapping ports, dependencies, and support teams.
...
This document provides comprehensive information about service catalog.
