...
Publish `docs/operations/release-calendar.md` showing planned foundational releases and owners.
...
This document provides comprehensive information about release calendar.
