...
Add `docs/operations/backup-strategy.md` describing data retention and restore procedures.
...
This document provides comprehensive information about backup strategy.
