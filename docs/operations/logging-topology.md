...
Create `docs/operations/logging-topology.md` detailing how logs are aggregated during local runs.
...
This document provides comprehensive information about logging topology.
