...
Create `docs/operations/windows-bootstrap.md` covering Windows-specific setup nuances.
...
This document provides comprehensive information about windows bootstrap.
