...
Add `docs/operations/operations_audit.md` delivering recurring audits for operations readiness across services.
...
This document provides comprehensive information about operations audit.
