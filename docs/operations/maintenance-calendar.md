...
Create `docs/operations/maintenance-calendar.md` coordinating downtime for foundational systems.
...
This document provides comprehensive information about maintenance calendar.
