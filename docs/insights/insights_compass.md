...
Ship `docs/insights/insights_compass.md` acting as a compass so teams can navigate insight sharing.
...
This document provides comprehensive information about insights compass.
