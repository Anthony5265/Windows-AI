...
Provide `assets/templates/pull-request.md` with checklists tailored to foundational deliverables.
...
This document provides comprehensive information about pull request.
