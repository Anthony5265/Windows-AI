...
Add `security/policies/security_policies_sentinel.md` standing up sentinel coverage that reinforces policy governance.
...
This document provides comprehensive information about security policies sentinel.
