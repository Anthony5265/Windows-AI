...
Build `security/hardening/secure_boot_guidance.md` guiding BIOS/UEFI settings.
...
This document provides comprehensive information about secure boot guidance.
