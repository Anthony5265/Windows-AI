...
Publish `mobile/docs/push-notification-guide.md` documenting configuration for major platforms.
...
This document provides comprehensive information about push notification guide.
