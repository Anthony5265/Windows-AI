"""
Gaming Integration 2 - PRODUCTION
Gaming integration number 2
"""
...
class GamingIntegration2Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="gaming_2",
            name="Gaming Integration 2",
            description="Gaming integration number 2",
            version="2.0.0",
        ...
        self.base_url = "https://api.gaming_2.com"
...
plugin = GamingIntegration2Plugin()
