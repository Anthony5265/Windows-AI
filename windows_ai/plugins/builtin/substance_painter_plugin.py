...
class Plugin:
    """Plugin for Substance Painter integration"""
    
    def __init__(self):
        self.name = "Substance Painter"
        self.version = "1.0.0"
        self.description = "Substance Painter integration"
        
        # Configuration
        self.api_key = os.getenv("SUBSTANCE_PAINTER_API_KEY", "")
        self.base_url = "https://api.substancepainter.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Substance Painter request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Substance Painter"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Substance Painter"""
