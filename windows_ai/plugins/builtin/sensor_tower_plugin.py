...
class Plugin:
    """Plugin for Sensor Tower integration"""
    
    def __init__(self):
        self.name = "Sensor Tower"
        self.version = "1.0.0"
        self.description = "Sensor Tower integration"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Sensor Tower"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Sensor Tower"""
