"""
Translation Tools Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Translation Tools local integration"""
    
    def __init__(self):
        self.name = "Translation Tools"
        self.version = "1.0.0"
        self.description = "Translation Tools integration"
        self.executable = "translation-tools"
