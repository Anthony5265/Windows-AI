"""
Cloud Storage Providers Onedrive Etc Plugin - Storage/Database integration
Cloud Storage Providers Onedrive Etc integration
"""
...
class Plugin:
    """Plugin for Cloud Storage Providers Onedrive Etc storage"""
    
    def __init__(self):
        self.name = "Cloud Storage Providers Onedrive Etc"
        self.version = "1.0.0"
        self.description = "Cloud Storage Providers Onedrive Etc integration"
        self.api_key = os.getenv("CLOUD_STORAGE_PROVIDERS_ONEDRIVE_ETC_API_KEY", "")
        self.base_url = "https://api.cloudstorageprovidersonedriveetc.com"
