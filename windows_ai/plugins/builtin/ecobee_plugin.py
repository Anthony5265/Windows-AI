...
class Plugin:
    """Plugin for Ecobee integration"""
    
    def __init__(self):
        self.name = "Ecobee"
        self.version = "1.0.0"
        self.description = "Ecobee thermostat"
        
        # Configuration
        self.api_key = os.getenv("ECOBEE_API_KEY", "")
        self.base_url = "https://api.ecobee.com/1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Ecobee request
