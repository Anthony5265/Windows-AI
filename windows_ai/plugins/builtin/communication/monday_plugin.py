"""
Monday.com - Production Implementation
Work OS
"""
...
class MondaycomPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["monday", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("MONDAY_API_KEY", "")
        self.base_url = os.getenv("MONDAY_URL", "https://api.monday.com")
