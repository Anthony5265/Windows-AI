"""
Confluence - Production Implementation
Documentation
"""
...
class ConfluencePlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["confluence", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("CONFLUENCE_API_KEY", "")
        self.base_url = os.getenv("CONFLUENCE_URL", "https://api.confluence.com")
