...
class Plugin:
    """Plugin for Critical Css integration"""
    
    def __init__(self):
        self.name = "Critical Css"
        self.version = "1.0.0"
        self.description = "Critical Css integration"
        
        # Configuration
        self.api_key = os.getenv("CRITICAL_CSS_API_KEY", "")
        self.base_url = "https://api.criticalcss.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Critical Css request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Critical Css"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Critical Css"""
