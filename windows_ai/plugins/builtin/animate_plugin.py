...
class Plugin:
    """Plugin for Animate integration"""
    
    def __init__(self):
        self.name = "Animate"
        self.version = "1.0.0"
        self.description = "Animate integration"
        
        # Configuration
        self.api_key = os.getenv("ANIMATE_API_KEY", "")
        self.base_url = "https://api.animate.com/v1"
        self.timeout = 30
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Animate"""
