"""
Teradata Plugin - Storage/Database integration
...
class Plugin:
    """Plugin for Teradata storage"""
    
    def __init__(self):
        self.name = "Teradata"
        self.version = "1.0.0"
        self.description = "Teradata integration"
        self.api_key = os.getenv("TERADATA_API_KEY", "")
        self.base_url = "https://api.teradata.com"
