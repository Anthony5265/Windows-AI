"""
Productivity Integration 2 - PRODUCTION
Productivity integration number 2
"""
...
class ProductivityIntegration2Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="productivity_2",
            name="Productivity Integration 2",
            description="Productivity integration number 2",
            version="2.0.0",
        ...
        self.api_key = os.getenv("PRODUCTIVITY_2_API_KEY", "")
        self.base_url = "https://api.productivity_2.com"
...
plugin = ProductivityIntegration2Plugin()
