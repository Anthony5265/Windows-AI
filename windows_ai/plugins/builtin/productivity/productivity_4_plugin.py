"""
Productivity Integration 4 - PRODUCTION
Productivity integration number 4
"""
...
class ProductivityIntegration4Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="productivity_4",
            name="Productivity Integration 4",
            description="Productivity integration number 4",
            version="2.0.0",
        ...
        self.api_key = os.getenv("PRODUCTIVITY_4_API_KEY", "")
        self.base_url = "https://api.productivity_4.com"
...
plugin = ProductivityIntegration4Plugin()
