...
class Plugin:
    """Plugin for Doppler integration"""
    
    def __init__(self):
        self.name = "Doppler"
        self.version = "1.0.0"
        self.description = "Doppler integration"
        
        # Configuration
        self.api_key = os.getenv("DOPPLER_API_KEY", "")
        self.base_url = "https://api.doppler.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Doppler request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Doppler"""
