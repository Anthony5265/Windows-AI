...
class Plugin:
    """Plugin for Aptos integration"""
    
    def __init__(self):
        self.name = "Aptos"
        self.version = "1.0.0"
        self.description = "Aptos integration"
        
        # Configuration
        self.api_key = os.getenv("APTOS_API_KEY", "")
        self.base_url = "https://api.aptos.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Aptos request
