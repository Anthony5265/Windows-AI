...
class Plugin:
    """Plugin for Elastic Apm integration"""
    
    def __init__(self):
        self.name = "Elastic Apm"
        self.version = "1.0.0"
        self.description = "Elastic Apm integration"
        
        # Configuration
        self.api_key = os.getenv("ELASTIC_APM_API_KEY", "")
        self.base_url = "https://api.elasticapm.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Elastic Apm request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Elastic Apm"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Elastic Apm"""
