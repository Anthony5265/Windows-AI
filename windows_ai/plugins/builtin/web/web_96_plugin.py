"""
Web Integration 96 - PRODUCTION
Web integration number 96
"""
...
class WebIntegration96Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_96",
            name="Web Integration 96",
            description="Web integration number 96",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_96_API_KEY", "")
        self.base_url = "https://api.web_96.com"
