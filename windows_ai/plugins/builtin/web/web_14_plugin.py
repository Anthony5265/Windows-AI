"""
Web Integration 14 - PRODUCTION
Web integration number 14
"""
...
class WebIntegration14Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_14",
            name="Web Integration 14",
            description="Web integration number 14",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_14_API_KEY", "")
        self.base_url = "https://api.web_14.com"
