"""
Web Integration 25 - PRODUCTION
Web integration number 25
"""
...
class WebIntegration25Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_25",
            name="Web Integration 25",
            description="Web integration number 25",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_25_API_KEY", "")
        self.base_url = "https://api.web_25.com"
