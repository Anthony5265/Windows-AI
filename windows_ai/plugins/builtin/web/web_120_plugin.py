"""
Web Integration 120 - PRODUCTION
Web integration number 120
"""
...
class WebIntegration120Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_120",
            name="Web Integration 120",
            description="Web integration number 120",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_120_API_KEY", "")
        self.base_url = "https://api.web_120.com"
...
plugin = WebIntegration120Plugin()
