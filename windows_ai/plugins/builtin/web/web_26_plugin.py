"""
Web Integration 26 - PRODUCTION
Web integration number 26
"""
...
class WebIntegration26Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_26",
            name="Web Integration 26",
            description="Web integration number 26",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_26_API_KEY", "")
        self.base_url = "https://api.web_26.com"
