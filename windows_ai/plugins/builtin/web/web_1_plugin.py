"""
Web Integration 1 - PRODUCTION
Web integration number 1
"""
...
class WebIntegration1Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_1",
            name="Web Integration 1",
            description="Web integration number 1",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_1_API_KEY", "")
        self.base_url = "https://api.web_1.com"
