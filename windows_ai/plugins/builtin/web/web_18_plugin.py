"""
Web Integration 18 - PRODUCTION
Web integration number 18
"""
...
class WebIntegration18Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_18",
            name="Web Integration 18",
            description="Web integration number 18",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_18_API_KEY", "")
        self.base_url = "https://api.web_18.com"
