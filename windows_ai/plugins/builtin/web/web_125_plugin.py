"""
Web Integration 125 - PRODUCTION
Web integration number 125
"""
...
class WebIntegration125Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_125",
            name="Web Integration 125",
            description="Web integration number 125",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_125_API_KEY", "")
        self.base_url = "https://api.web_125.com"
...
plugin = WebIntegration125Plugin()
