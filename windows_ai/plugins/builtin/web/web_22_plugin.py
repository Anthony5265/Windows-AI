"""
Web Integration 22 - PRODUCTION
Web integration number 22
"""
...
class WebIntegration22Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_22",
            name="Web Integration 22",
            description="Web integration number 22",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_22_API_KEY", "")
        self.base_url = "https://api.web_22.com"
