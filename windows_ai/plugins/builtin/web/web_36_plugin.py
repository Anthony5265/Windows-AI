"""
Web Integration 36 - PRODUCTION
Web integration number 36
"""
...
class WebIntegration36Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_36",
            name="Web Integration 36",
            description="Web integration number 36",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_36_API_KEY", "")
        self.base_url = "https://api.web_36.com"
