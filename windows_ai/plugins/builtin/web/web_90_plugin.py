"""
Web Integration 90 - PRODUCTION
Web integration number 90
"""
...
class WebIntegration90Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_90",
            name="Web Integration 90",
            description="Web integration number 90",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_90_API_KEY", "")
        self.base_url = "https://api.web_90.com"
