"""
Web Integration 4 - PRODUCTION
Web integration number 4
"""
...
class WebIntegration4Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_4",
            name="Web Integration 4",
            description="Web integration number 4",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_4_API_KEY", "")
        self.base_url = "https://api.web_4.com"
