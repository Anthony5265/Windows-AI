"""
Web Integration 27 - PRODUCTION
Web integration number 27
"""
...
class WebIntegration27Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_27",
            name="Web Integration 27",
            description="Web integration number 27",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_27_API_KEY", "")
        self.base_url = "https://api.web_27.com"
