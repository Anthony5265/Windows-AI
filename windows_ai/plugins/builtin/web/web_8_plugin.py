"""
Web Integration 8 - PRODUCTION
Web integration number 8
"""
...
class WebIntegration8Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_8",
            name="Web Integration 8",
            description="Web integration number 8",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_8_API_KEY", "")
        self.base_url = "https://api.web_8.com"
