"""
Web Integration 60 - PRODUCTION
Web integration number 60
"""
...
class WebIntegration60Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_60",
            name="Web Integration 60",
            description="Web integration number 60",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_60_API_KEY", "")
        self.base_url = "https://api.web_60.com"
