"""
Web Integration 24 - PRODUCTION
Web integration number 24
"""
...
class WebIntegration24Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_24",
            name="Web Integration 24",
            description="Web integration number 24",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_24_API_KEY", "")
        self.base_url = "https://api.web_24.com"
