"""
Web Integration 28 - PRODUCTION
Web integration number 28
"""
...
class WebIntegration28Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_28",
            name="Web Integration 28",
            description="Web integration number 28",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_28_API_KEY", "")
        self.base_url = "https://api.web_28.com"
