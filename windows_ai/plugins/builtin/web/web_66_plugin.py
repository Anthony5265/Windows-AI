"""
Web Integration 66 - PRODUCTION
Web integration number 66
"""
...
class WebIntegration66Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_66",
            name="Web Integration 66",
            description="Web integration number 66",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_66_API_KEY", "")
        self.base_url = "https://api.web_66.com"
