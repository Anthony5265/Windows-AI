...
class WebIntegration2Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_2",
            name="Web Integration 2",
            description="Web integration number 2",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_2_API_KEY", "")
        self.base_url = "https://api.web_2.com"
