"""
Web Integration 130 - PRODUCTION
Web integration number 130
"""
...
class WebIntegration130Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_130",
            name="Web Integration 130",
            description="Web integration number 130",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_130_API_KEY", "")
        self.base_url = "https://api.web_130.com"
...
plugin = WebIntegration130Plugin()
