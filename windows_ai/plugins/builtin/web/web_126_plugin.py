"""
Web Integration 126 - PRODUCTION
Web integration number 126
"""
...
class WebIntegration126Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_126",
            name="Web Integration 126",
            description="Web integration number 126",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_126_API_KEY", "")
        self.base_url = "https://api.web_126.com"
...
plugin = WebIntegration126Plugin()
