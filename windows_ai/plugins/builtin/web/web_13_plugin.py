"""
Web Integration 13 - PRODUCTION
Web integration number 13
"""
...
class WebIntegration13Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_13",
            name="Web Integration 13",
            description="Web integration number 13",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_13_API_KEY", "")
        self.base_url = "https://api.web_13.com"
