"""
Web Integration 17 - PRODUCTION
Web integration number 17
"""
...
class WebIntegration17Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_17",
            name="Web Integration 17",
            description="Web integration number 17",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_17_API_KEY", "")
        self.base_url = "https://api.web_17.com"
