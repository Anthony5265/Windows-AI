...
class WebIntegration3Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_3",
            name="Web Integration 3",
            description="Web integration number 3",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_3_API_KEY", "")
        self.base_url = "https://api.web_3.com"
