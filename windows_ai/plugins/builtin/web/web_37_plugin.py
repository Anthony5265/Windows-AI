"""
Web Integration 37 - PRODUCTION
Web integration number 37
"""
...
class WebIntegration37Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="web_37",
            name="Web Integration 37",
            description="Web integration number 37",
            version="2.0.0",
        ...
        self.api_key = os.getenv("WEB_37_API_KEY", "")
        self.base_url = "https://api.web_37.com"
