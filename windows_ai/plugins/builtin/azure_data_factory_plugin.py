"""
Azure Data Factory Plugin - Storage/Database integration
...
class Plugin:
    """Plugin for Azure Data Factory storage"""
    
    def __init__(self):
        self.name = "Azure Data Factory"
        self.version = "1.0.0"
        self.description = "Azure Data Factory integration"
        self.api_key = os.getenv("AZURE_DATA_FACTORY_API_KEY", "")
        self.base_url = "https://api.azuredatafactory.com"
