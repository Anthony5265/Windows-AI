...
class Plugin:
    """Plugin for Wyze integration"""
    
    def __init__(self):
        self.name = "Wyze"
        self.version = "1.0.0"
        self.description = "Wyze cameras"
        
        # Configuration
        self.api_key = os.getenv("WYZE_API_KEY", "")
        self.base_url = "https://api.wyzecam.com/app"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Wyze request
