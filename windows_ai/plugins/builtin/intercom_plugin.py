...
class Plugin:
    """Plugin for Intercom integration"""
    
    def __init__(self):
        self.name = "Intercom"
        self.version = "1.0.0"
        self.description = "Intercom messaging"
        
        # Configuration
        self.api_key = os.getenv("INTERCOM_ACCESS_TOKEN", "")
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Intercom"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Intercom"""
