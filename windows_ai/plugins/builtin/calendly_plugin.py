...
class Plugin:
    """Plugin for Calendly integration"""
    
    def __init__(self):
        self.name = "Calendly"
        self.version = "1.0.0"
        self.description = "Calendly scheduling"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Calendly"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Calendly"""
