...
class Plugin:
    """Plugin for Checkly integration"""
    
    def __init__(self):
        self.name = "Checkly"
        self.version = "1.0.0"
        self.description = "Checkly integration"
        
        # Configuration
        self.api_key = os.getenv("CHECKLY_API_KEY", "")
        self.base_url = "https://api.checkly.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Checkly request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Checkly"""
