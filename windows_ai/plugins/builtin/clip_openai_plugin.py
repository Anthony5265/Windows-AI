"""
Clip Openai Plugin - Local Tool Integration
Clip Openai integration
"""
...
class Plugin:
    """Plugin for Clip Openai local integration"""
    
    def __init__(self):
        self.name = "Clip Openai"
        self.version = "1.0.0"
        self.description = "Clip Openai integration"
        self.executable = "clip-openai"
