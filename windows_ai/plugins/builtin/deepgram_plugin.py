...
class Plugin:
    """Plugin for Deepgram integration"""
    
    def __init__(self):
        self.name = "Deepgram"
        self.version = "1.0.0"
        self.description = "Deepgram integration"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Deepgram"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Deepgram"""
