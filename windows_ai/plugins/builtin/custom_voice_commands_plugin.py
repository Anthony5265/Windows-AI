"""
Custom Voice Commands Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Custom Voice Commands local integration"""
    
    def __init__(self):
        self.name = "Custom Voice Commands"
        self.version = "1.0.0"
        self.description = "Custom Voice Commands integration"
        self.executable = "custom-voice-commands"
