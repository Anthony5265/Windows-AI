"""
KoboldAI Plugin - Local Tool Integration
Local AI for creative writing
"""
...
class Plugin:
    """Plugin for KoboldAI local integration"""
    
    def __init__(self):
        self.name = "KoboldAI"
        self.version = "1.0.0"
        self.description = "Local AI for creative writing"
