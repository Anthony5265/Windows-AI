...
class Plugin:
    """Plugin for Sui integration"""
    
    def __init__(self):
        self.name = "Sui"
        self.version = "1.0.0"
        self.description = "Sui integration"
        
        # Configuration
        self.api_key = os.getenv("SUI_API_KEY", "")
        self.base_url = "https://api.sui.com/v1"
        self.timeout = 30
