"""
TASK-113: IntelliJ IDEA Plugin - Production Implementation
PSI API plugin
"""
...
class IntelliJIDEAPlugin(IntegrationPlugin):
    """IntelliJ IDEA integration plugin"""

    def __init__(self):
        metadata = PluginMetadata(
            id="task-113_intellij_idea",
            name="IntelliJ IDEA",
            description="PSI API plugin",
            version="1.0.0",
        ...
        self.api_key = os.getenv("INTELLIJ_IDEA_API_KEY", "")
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info("IntelliJ IDEA plugin initialized")
            return True
    ...
    async def connect(self, credentials: Dict[str, str]) -> bool:
        ...
        try:
            ...
            self.connected = True
            logger.info("Connected to IntelliJ IDEA")
            return True
        except Exception as e:
    ...
    async def execute(self, action: str, parameters: Dict[str, Any], **kwargs) -> Dict[str, Any]:
        ...
        if not self.connected:
            return {"success": False, "error": "Not connected to IntelliJ IDEA"}
        ...
        try:
            ...
            async with self.session.post(
                ...
                if response.status == 200:
                    ...
                    raise Exception(f"IntelliJ IDEA API error {response.status}: {error}")
        except Exception as e:
    ...
    def get_schema(self) -> Dict[str, Any]:
        ...
        return {
            "type": "object",
            "properties": {
                "action": {"type": "string", "enum": ['parse', 'analyze', 'refactor', 'generate']},
