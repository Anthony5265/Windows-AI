"""
TASK-115: WebStorm Plugin - Production Implementation
...
class WebStormPlugin(IntegrationPlugin):
    """WebStorm integration plugin"""

    def __init__(self):
        metadata = PluginMetadata(
            id="task-115_webstorm",
            name="WebStorm",
        ...
        self.api_key = os.getenv("WEBSTORM_API_KEY", "")
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info("WebStorm plugin initialized")
            return True
    ...
    async def connect(self, credentials: Dict[str, str]) -> bool:
        ...
        try:
            ...
            self.connected = True
            logger.info("Connected to WebStorm")
            return True
        except Exception as e:
    ...
    async def execute(self, action: str, parameters: Dict[str, Any], **kwargs) -> Dict[str, Any]:
        ...
        if not self.connected:
            return {"success": False, "error": "Not connected to WebStorm"}
        ...
        try:
            ...
            async with self.session.post(
                ...
                if response.status == 200:
                    ...
                    raise Exception(f"WebStorm API error {response.status}: {error}")
        except Exception as e:
    ...
    def get_schema(self) -> Dict[str, Any]:
        ...
        return {
            "type": "object",
            "properties": {
                "action": {"type": "string", "enum": ['complete', 'refactor', 'debug', 'test']},
