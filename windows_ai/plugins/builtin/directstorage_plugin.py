"""
Directstorage Plugin - Storage/Database integration
...
class Plugin:
    """Plugin for Directstorage storage"""
    
    def __init__(self):
        self.name = "Directstorage"
        self.version = "1.0.0"
        self.description = "Directstorage integration"
        self.api_key = os.getenv("DIRECTSTORAGE_API_KEY", "")
        self.base_url = "https://api.directstorage.com"
