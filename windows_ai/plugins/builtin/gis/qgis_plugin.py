"""
QGIS - Production Implementation
Open-source GIS
"""
...
class QGISPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["qgis", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("QGIS_API_KEY", "")
        self.base_url = os.getenv("QGIS_URL", "https://api.qgis.com")
