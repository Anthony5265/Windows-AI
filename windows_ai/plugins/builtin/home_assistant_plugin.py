...
class Plugin:
    ...
    def __init__(self):
        ...
        # Configuration
        self.api_key = os.getenv("HOME_ASSISTANT_API_KEY", "")
        self.base_url = "https://api.homeassistant.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Home Assistant request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Home Assistant"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Home Assistant"""
