"""
Roam Research Plugin - Storage/Database integration
Roam networked notes
"""
...
class Plugin:
    """Plugin for Roam Research storage"""
    
    def __init__(self):
        self.name = "Roam Research"
        self.version = "1.0.0"
        self.description = "Roam networked notes"
        self.api_key = os.getenv("ROAM_API_KEY", "")
