...
class Plugin:
    """Plugin for Udemy integration"""
    
    def __init__(self):
        self.name = "Udemy"
        self.version = "1.0.0"
        self.description = "Udemy courses"
        
        # Configuration
        self.api_key = os.getenv("UDEMY_CLIENT_ID", "")
        self.base_url = "https://www.udemy.com/api-2.0"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Udemy request
