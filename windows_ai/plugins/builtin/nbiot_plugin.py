...
class Plugin:
    """Plugin for Nbiot integration"""
    
    def __init__(self):
        self.name = "Nbiot"
        self.version = "1.0.0"
        self.description = "Nbiot integration"
        
        # Configuration
        self.api_key = os.getenv("NBIOT_API_KEY", "")
        self.base_url = "https://api.nbiot.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Nbiot request
