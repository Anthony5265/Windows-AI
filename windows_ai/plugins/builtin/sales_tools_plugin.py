"""
Sales Tools Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Sales Tools local integration"""
    
    def __init__(self):
        self.name = "Sales Tools"
        self.version = "1.0.0"
        self.description = "Sales Tools integration"
        self.executable = "sales-tools"
