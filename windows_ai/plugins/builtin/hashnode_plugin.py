...
class Plugin:
    """Plugin for Hashnode integration"""
    
    def __init__(self):
        self.name = "Hashnode"
        self.version = "1.0.0"
        self.description = "Hashnode blogging"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Hashnode"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Hashnode"""
