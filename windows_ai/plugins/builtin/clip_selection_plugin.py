"""
Clip Selection Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Clip Selection local integration"""
    
    def __init__(self):
        self.name = "Clip Selection"
        self.version = "1.0.0"
        self.description = "Clip Selection integration"
        self.executable = "clip-selection"
