...
class Plugin:
    """Plugin for Tado integration"""
    
    def __init__(self):
        self.name = "Tado"
        self.version = "1.0.0"
        self.description = "Tado integration"
        
        # Configuration
        self.api_key = os.getenv("TADO_API_KEY", "")
        self.base_url = "https://api.tado.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Tado request
