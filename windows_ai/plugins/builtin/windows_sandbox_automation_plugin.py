"""
Windows Sandbox Automation Plugin - Storage/Database integration
Windows Sandbox Automation integration
"""
...
class Plugin:
    """Plugin for Windows Sandbox Automation storage"""
    
    def __init__(self):
        self.name = "Windows Sandbox Automation"
        self.version = "1.0.0"
        self.description = "Windows Sandbox Automation integration"
        self.api_key = os.getenv("WINDOWS_SANDBOX_AUTOMATION_API_KEY", "")
        self.base_url = "https://api.windowssandboxautomation.com"
