...
class Plugin:
    """Plugin for Losant integration"""
    
    def __init__(self):
        self.name = "Losant"
        self.version = "1.0.0"
        self.description = "Losant integration"
        
        # Configuration
        self.api_key = os.getenv("LOSANT_API_KEY", "")
        self.base_url = "https://api.losant.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Losant request
