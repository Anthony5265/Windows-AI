...
class Plugin:
    """Plugin for Doodle integration"""
    
    def __init__(self):
        self.name = "Doodle"
        self.version = "1.0.0"
        self.description = "Doodle integration"
        
        # Configuration
        self.api_key = os.getenv("DOODLE_API_KEY", "")
        self.base_url = "https://api.doodle.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Doodle request
