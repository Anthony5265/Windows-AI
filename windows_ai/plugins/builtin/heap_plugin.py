...
class Plugin:
    """Plugin for Heap integration"""
    
    def __init__(self):
        self.name = "Heap"
        self.version = "1.0.0"
        self.description = "Heap integration"
        
        # Configuration
        self.api_key = os.getenv("HEAP_API_KEY", "")
        self.base_url = "https://api.heap.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Heap request
