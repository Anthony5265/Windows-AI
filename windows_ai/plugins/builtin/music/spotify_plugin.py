"""
Spotify - Production Implementation
Music streaming
"""
...
class SpotifyPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["spotify", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("SPOTIFY_API_KEY", "")
        self.base_url = os.getenv("SPOTIFY_URL", "https://api.spotify.com")
