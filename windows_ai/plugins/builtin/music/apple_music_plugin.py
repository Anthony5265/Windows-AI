"""
Apple Music - Production Implementation
Music service
"""
...
class AppleMusicPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["apple_music", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("APPLE_MUSIC_API_KEY", "")
        self.base_url = os.getenv("APPLE_MUSIC_URL", "https://api.apple_music.com")
