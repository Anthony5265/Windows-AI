"""
Native Modules Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Native Modules local integration"""
    
    def __init__(self):
        self.name = "Native Modules"
        self.version = "1.0.0"
        self.description = "Native Modules integration"
        self.executable = "native-modules"
