"""
Ftpsftp Clients Plugin - Local Tool Integration
Ftpsftp Clients integration
"""
...
class Plugin:
    """Plugin for Ftpsftp Clients local integration"""
    
    def __init__(self):
        self.name = "Ftpsftp Clients"
        self.version = "1.0.0"
        self.description = "Ftpsftp Clients integration"
        self.executable = "ftpsftp-clients"
