...
class Plugin:
    """Plugin for Metagpt integration"""
    
    def __init__(self):
        self.name = "Metagpt"
        self.version = "1.0.0"
        self.description = "Metagpt integration"
        
        # Configuration
        self.api_key = os.getenv("METAGPT_API_KEY", "")
        self.base_url = "https://api.metagpt.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Metagpt request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Metagpt"""
