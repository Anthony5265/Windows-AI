...
class Plugin:
    """Plugin for Florence2 integration"""
    
    def __init__(self):
        self.name = "Florence2"
        self.version = "1.0.0"
        self.description = "Florence2 integration"
        
        # Configuration
        self.api_key = os.getenv("FLORENCE2_API_KEY", "")
        self.base_url = "https://api.florence2.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Florence2 request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Florence2"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Florence2"""
