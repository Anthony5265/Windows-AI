...
class Plugin:
    ...
    def __init__(self):
        self.name = "Solana"
        self.version = "1.0.0"
        self.description = "Solana integration"
        
        # Configuration
        self.api_key = os.getenv("SOLANA_API_KEY", "")
        self.base_url = "https://api.solana.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Solana request
