...
class Plugin:
    """Plugin for Text Selection Context integration"""
    
    def __init__(self):
        self.name = "Text Selection Context"
        self.version = "1.0.0"
        self.description = "Text Selection Context integration"
        
        # Configuration
        self.api_key = os.getenv("TEXT_SELECTION_CONTEXT_API_KEY", "")
        self.base_url = "https://api.textselectioncontext.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Text Selection Context request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Text Selection Context"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Text Selection Context"""
