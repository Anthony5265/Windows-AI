...
class Plugin:
    """Plugin for Edx integration"""
    
    def __init__(self):
        self.name = "Edx"
        self.version = "1.0.0"
        self.description = "Edx integration"
        
        # Configuration
        self.api_key = os.getenv("EDX_API_KEY", "")
        self.base_url = "https://api.edx.com/v1"
        self.timeout = 30
