"""
Industry Integration 27 - PRODUCTION
Industry integration number 27
"""
...
class IndustryIntegration27Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="industry_27",
            name="Industry Integration 27",
            description="Industry integration number 27",
            version="2.0.0",
        ...
        self.api_key = os.getenv("INDUSTRY_27_API_KEY", "")
        self.base_url = "https://api.industry_27.com"
...
plugin = IndustryIntegration27Plugin()
