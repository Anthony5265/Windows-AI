"""
Industry Integration 25 - PRODUCTION
Industry integration number 25
"""
...
class IndustryIntegration25Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="industry_25",
            name="Industry Integration 25",
            description="Industry integration number 25",
            version="2.0.0",
        ...
        self.api_key = os.getenv("INDUSTRY_25_API_KEY", "")
        self.base_url = "https://api.industry_25.com"
...
plugin = IndustryIntegration25Plugin()
