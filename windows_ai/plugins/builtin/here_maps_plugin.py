...
class Plugin:
    """Plugin for HERE Maps integration"""
    
    def __init__(self):
        self.name = "HERE Maps"
        self.version = "1.0.0"
        self.description = "HERE location"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using HERE Maps"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using HERE Maps"""
