...
class Plugin:
    """Plugin for Shopify integration"""
    
    def __init__(self):
        self.name = "Shopify"
        self.version = "1.0.0"
        self.description = "Shopify store"
        
        # Configuration
        self.api_key = os.getenv("SHOPIFY_ACCESS_TOKEN", "")
        self.base_url = "https://your-shop.myshopify.com/admin/api/2023-10"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Shopify request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Shopify"""
