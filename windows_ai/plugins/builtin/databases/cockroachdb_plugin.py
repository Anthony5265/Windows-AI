"""
CockroachDB - Production Implementation
Distributed SQL
"""
...
class CockroachDBPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["cockroachdb", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("COCKROACHDB_API_KEY", "")
        self.base_url = os.getenv("COCKROACHDB_URL", "https://api.cockroachdb.com")
