"""
Neo4j - Production Implementation
Graph database
"""
...
class Neo4jPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["neo4j", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("NEO4J_API_KEY", "")
        self.base_url = os.getenv("NEO4J_URL", "https://api.neo4j.com")
