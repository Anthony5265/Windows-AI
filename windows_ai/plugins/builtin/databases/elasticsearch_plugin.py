...
class ElasticsearchPlugin(IntegrationPlugin):
    def __init__(self):
        ...
        self.base_url = os.getenv("ELASTICSEARCH_URL", "https://api.elasticsearch.com")
    ...
    async def _index(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        async with self.session.post(
            ...
            raise Exception(f"index failed: {response.status}")
