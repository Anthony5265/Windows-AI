"""
Cassandra - Production Implementation
Wide-column store
"""
...
class CassandraPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["cassandra", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("CASSANDRA_API_KEY", "")
        self.base_url = os.getenv("CASSANDRA_URL", "https://api.cassandra.com")
    ...
    async def _select(self, params: Dict[str, Any]) -> Dict[str, Any]:
        ...
        async with self.session.post(
            ...
            raise Exception(f"select failed: {response.status}")
