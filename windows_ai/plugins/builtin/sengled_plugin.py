...
class Plugin:
    """Plugin for Sengled integration"""
    
    def __init__(self):
        self.name = "Sengled"
        self.version = "1.0.0"
        self.description = "Sengled integration"
        
        # Configuration
        self.api_key = os.getenv("SENGLED_API_KEY", "")
        self.base_url = "https://api.sengled.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Sengled request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Sengled"""
