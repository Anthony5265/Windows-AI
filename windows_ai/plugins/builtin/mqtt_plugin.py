...
class Plugin:
    """Plugin for Mqtt integration"""
    
    def __init__(self):
        self.name = "Mqtt"
        self.version = "1.0.0"
        self.description = "Mqtt integration"
        
        # Configuration
        self.api_key = os.getenv("MQTT_API_KEY", "")
        self.base_url = "https://api.mqtt.com/v1"
        self.timeout = 30
