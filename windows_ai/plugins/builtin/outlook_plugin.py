...
class Plugin:
    """Plugin for Outlook integration"""
    
    def __init__(self):
        self.name = "Outlook"
        self.version = "1.0.0"
        self.description = "Outlook email and calendar"
        
        # Configuration
        self.api_key = os.getenv("OUTLOOK_ACCESS_TOKEN", "")
        self.base_url = "https://graph.microsoft.com/v1.0"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Outlook request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Outlook"""
