"""
Amazon SES - Production Implementation
Email service
"""
...
class AmazonSESPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["amazon_ses", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("AMAZON_SES_API_KEY", "")
        self.base_url = os.getenv("AMAZON_SES_URL", "https://api.amazon_ses.com")
