"""
SendGrid - Production Implementation
Email delivery
"""
...
class SendGridPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["sendgrid", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("SENDGRID_API_KEY", "")
        self.base_url = os.getenv("SENDGRID_URL", "https://api.sendgrid.com")
