"""
Postmark - Production Implementation
Transactional email
"""
...
class PostmarkPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["postmark", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("POSTMARK_API_KEY", "")
        self.base_url = os.getenv("POSTMARK_URL", "https://api.postmark.com")
