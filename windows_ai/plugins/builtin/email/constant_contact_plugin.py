"""
Constant Contact - Production Implementation
Email marketing
"""
...
class ConstantContactPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["constant_contact", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("CONSTANT_CONTACT_API_KEY", "")
        self.base_url = os.getenv("CONSTANT_CONTACT_URL", "https://api.constant_contact.com")
