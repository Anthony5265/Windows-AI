"""
Zoho CRM - Production Implementation
Customer management
"""
...
class ZohoCRMPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["zoho_crm", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("ZOHO_CRM_API_KEY", "")
        self.base_url = os.getenv("ZOHO_CRM_URL", "https://api.zoho_crm.com")
