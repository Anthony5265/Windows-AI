"""
Nimble - Production Implementation
Social CRM
"""
...
class NimblePlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["nimble", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("NIMBLE_API_KEY", "")
        self.base_url = os.getenv("NIMBLE_URL", "https://api.nimble.com")
    ...
    async def _interaction(self, params: Dict[str, Any]) -> Dict[str, Any]:
