"""
HubSpot - Production Implementation
Marketing & CRM
"""
...
class HubSpotPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["hubspot", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("HUBSPOT_API_KEY", "")
        self.base_url = os.getenv("HUBSPOT_URL", "https://api.hubspot.com")
