"""
Pipedrive - Production Implementation
Sales CRM
"""
...
class PipedrivePlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["pipedrive", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("PIPEDRIVE_API_KEY", "")
        self.base_url = os.getenv("PIPEDRIVE_URL", "https://api.pipedrive.com")
