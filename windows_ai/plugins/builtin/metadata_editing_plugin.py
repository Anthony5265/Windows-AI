"""
Metadata Editing Plugin - Storage/Database integration
...
class Plugin:
    """Plugin for Metadata Editing storage"""
    
    def __init__(self):
        self.name = "Metadata Editing"
        self.version = "1.0.0"
        self.description = "Metadata Editing integration"
        self.api_key = os.getenv("METADATA_EDITING_API_KEY", "")
        self.base_url = "https://api.metadataediting.com"
