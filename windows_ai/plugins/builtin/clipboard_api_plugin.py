"""
Clipboard Api Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Clipboard Api local integration"""
    
    def __init__(self):
        self.name = "Clipboard Api"
        self.version = "1.0.0"
        self.description = "Clipboard Api integration"
        self.executable = "clipboard-api"
