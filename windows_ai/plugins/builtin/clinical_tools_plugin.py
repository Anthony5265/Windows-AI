"""
Clinical Tools Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Clinical Tools local integration"""
    
    def __init__(self):
        self.name = "Clinical Tools"
        self.version = "1.0.0"
        self.description = "Clinical Tools integration"
        self.executable = "clinical-tools"
