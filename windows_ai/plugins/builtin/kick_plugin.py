...
class Plugin:
    """Plugin for Kick integration"""
    
    def __init__(self):
        self.name = "Kick"
        self.version = "1.0.0"
        self.description = "Kick integration"
        
        # Configuration
        self.api_key = os.getenv("KICK_API_KEY", "")
        self.base_url = "https://api.kick.com/v1"
        self.timeout = 30
