"""
React Native Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for React Native local integration"""
    
    def __init__(self):
        self.name = "React Native"
        self.version = "1.0.0"
        self.description = "React Native integration"
        self.executable = "react-native"
