"""
Performance Integration 3 - PRODUCTION
Performance integration number 3
"""
...
class PerformanceIntegration3Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="perf_3",
            name="Performance Integration 3",
            description="Performance integration number 3",
            version="2.0.0",
        ...
        self.api_key = os.getenv("PERF_3_API_KEY", "")
        self.base_url = "https://api.perf_3.com"
...
plugin = PerformanceIntegration3Plugin()
