"""
Performance Integration 1 - PRODUCTION
Performance integration number 1
"""
...
class PerformanceIntegration1Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="perf_1",
            name="Performance Integration 1",
            description="Performance integration number 1",
            version="2.0.0",
        ...
        self.api_key = os.getenv("PERF_1_API_KEY", "")
        self.base_url = "https://api.perf_1.com"
...
plugin = PerformanceIntegration1Plugin()
