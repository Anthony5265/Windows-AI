"""
Performance Integration 13 - PRODUCTION
Performance integration number 13
"""
...
class PerformanceIntegration13Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="perf_13",
            name="Performance Integration 13",
            description="Performance integration number 13",
            version="2.0.0",
        ...
        self.api_key = os.getenv("PERF_13_API_KEY", "")
        self.base_url = "https://api.perf_13.com"
...
plugin = PerformanceIntegration13Plugin()
