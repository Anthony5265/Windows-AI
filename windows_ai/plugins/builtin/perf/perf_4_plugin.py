"""
Performance Integration 4 - PRODUCTION
Performance integration number 4
"""
...
class PerformanceIntegration4Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="perf_4",
            name="Performance Integration 4",
            description="Performance integration number 4",
            version="2.0.0",
        ...
        self.api_key = os.getenv("PERF_4_API_KEY", "")
        self.base_url = "https://api.perf_4.com"
...
plugin = PerformanceIntegration4Plugin()
