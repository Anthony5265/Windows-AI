"""
Performance Integration 25 - PRODUCTION
Performance integration number 25
"""
...
class PerformanceIntegration25Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="perf_25",
            name="Performance Integration 25",
            description="Performance integration number 25",
            version="2.0.0",
        ...
        self.api_key = os.getenv("PERF_25_API_KEY", "")
        self.base_url = "https://api.perf_25.com"
...
plugin = PerformanceIntegration25Plugin()
