"""
Performance Integration 2 - PRODUCTION
Performance integration number 2
"""
...
class PerformanceIntegration2Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="perf_2",
            name="Performance Integration 2",
            description="Performance integration number 2",
            version="2.0.0",
        ...
        self.api_key = os.getenv("PERF_2_API_KEY", "")
        self.base_url = "https://api.perf_2.com"
...
plugin = PerformanceIntegration2Plugin()
