"""
Storage Sync Plugin - Storage/Database integration
...
class Plugin:
    """Plugin for Storage Sync storage"""
    
    def __init__(self):
        self.name = "Storage Sync"
        self.version = "1.0.0"
        self.description = "Storage Sync integration"
        self.api_key = os.getenv("STORAGE_SYNC_API_KEY", "")
        self.base_url = "https://api.storagesync.com"
