...
class Plugin:
    """Plugin for PayPal integration"""
    
    def __init__(self):
        self.name = "PayPal"
        self.version = "1.0.0"
        self.description = "PayPal payments"
        
        # Configuration
        self.api_key = os.getenv("PAYPAL_CLIENT_ID", "")
