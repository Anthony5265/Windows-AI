...
class Plugin:
    """Plugin for Toxicity Detection Perspective Api integration"""
    
    def __init__(self):
        self.name = "Toxicity Detection Perspective Api"
        self.version = "1.0.0"
        self.description = "Toxicity Detection Perspective Api integration"
        
        # Configuration
        self.api_key = os.getenv("TOXICITY_DETECTION_PERSPECTIVE_API_API_KEY", "")
        self.base_url = "https://api.toxicitydetectionperspectiveapi.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Toxicity Detection Perspective Api request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Toxicity Detection Perspective Api"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Toxicity Detection Perspective Api"""
