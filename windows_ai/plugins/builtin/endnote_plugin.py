...
class Plugin:
    """Plugin for Endnote integration"""
    
    def __init__(self):
        self.name = "Endnote"
        self.version = "1.0.0"
        self.description = "Endnote integration"
        
        # Configuration
        self.api_key = os.getenv("ENDNOTE_API_KEY", "")
        self.base_url = "https://api.endnote.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Endnote request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Endnote"""
