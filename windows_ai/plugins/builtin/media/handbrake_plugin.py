"""
Handbrake - Production Implementation
Video transcoder
"""
...
class HandbrakePlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["handbrake", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("HANDBRAKE_API_KEY", "")
        self.base_url = os.getenv("HANDBRAKE_URL", "https://api.handbrake.com")
