"""
Data Masking Plugin - Storage/Database integration
...
class Plugin:
    """Plugin for Data Masking storage"""
    
    def __init__(self):
        self.name = "Data Masking"
        self.version = "1.0.0"
        self.description = "Data Masking integration"
        self.api_key = os.getenv("DATA_MASKING_API_KEY", "")
        self.base_url = "https://api.datamasking.com"
