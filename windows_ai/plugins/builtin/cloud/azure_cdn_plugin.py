"""
Azure CDN - Production Implementation
Content delivery
"""
...
class AzureCDNPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["azure_cdn", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("AZURE_CDN_API_KEY", "")
        self.base_url = os.getenv("AZURE_CDN_URL", "https://api.azure_cdn.com")
