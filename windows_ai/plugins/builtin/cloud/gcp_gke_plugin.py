"""
GCP GKE - Production Implementation
Kubernetes
"""
...
class GCPGKEPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["gcp_gke", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("GCP_GKE_API_KEY", "")
        self.base_url = os.getenv("GCP_GKE_URL", "https://api.gcp_gke.com")
