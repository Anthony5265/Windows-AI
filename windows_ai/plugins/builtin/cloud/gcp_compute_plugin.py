"""
GCP Compute - Production Implementation
Virtual machines
"""
...
class GCPComputePlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["gcp_compute", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("GCP_COMPUTE_API_KEY", "")
        self.base_url = os.getenv("GCP_COMPUTE_URL", "https://api.gcp_compute.com")
