...
class AzureServiceBusPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["azure_servicebus", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("AZURE_SERVICEBUS_API_KEY", "")
        self.base_url = os.getenv("AZURE_SERVICEBUS_URL", "https://api.azure_servicebus.com")
