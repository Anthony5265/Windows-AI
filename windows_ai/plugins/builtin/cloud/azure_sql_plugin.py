"""
Azure SQL - Production Implementation
Managed SQL
"""
...
class AzureSQLPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["azure_sql", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("AZURE_SQL_API_KEY", "")
        self.base_url = os.getenv("AZURE_SQL_URL", "https://api.azure_sql.com")
