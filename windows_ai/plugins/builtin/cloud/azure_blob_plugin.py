"""
Azure Blob - Production Implementation
Object storage
"""
...
class AzureBlobPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["azure_blob", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("AZURE_BLOB_API_KEY", "")
        self.base_url = os.getenv("AZURE_BLOB_URL", "https://api.azure_blob.com")
