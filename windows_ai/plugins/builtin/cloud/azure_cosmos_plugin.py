"""
Azure Cosmos - Production Implementation
NoSQL database
"""
...
class AzureCosmosPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["azure_cosmos", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("AZURE_COSMOS_API_KEY", "")
        self.base_url = os.getenv("AZURE_COSMOS_URL", "https://api.azure_cosmos.com")
