...
class Plugin:
    """Plugin for Moodle integration"""
    
    def __init__(self):
        self.name = "Moodle"
        self.version = "1.0.0"
        self.description = "Moodle LMS"
        
        # Configuration
        self.api_key = os.getenv("MOODLE_TOKEN", "")
        self.base_url = "https://your-moodle.com/webservice/rest"
        self.timeout = 30
