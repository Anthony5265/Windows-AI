"""
Seller Tools Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Seller Tools local integration"""
    
    def __init__(self):
        self.name = "Seller Tools"
        self.version = "1.0.0"
        self.description = "Seller Tools integration"
        self.executable = "seller-tools"
