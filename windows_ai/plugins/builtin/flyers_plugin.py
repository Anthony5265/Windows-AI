...
class Plugin:
    """Plugin for Flyers integration"""
    
    def __init__(self):
        self.name = "Flyers"
        self.version = "1.0.0"
        self.description = "Flyers integration"
        
        # Configuration
        self.api_key = os.getenv("FLYERS_API_KEY", "")
        self.base_url = "https://api.flyers.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Flyers request
