"""
Rest Api Client Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Rest Api Client local integration"""
    
    def __init__(self):
        self.name = "Rest Api Client"
        self.version = "1.0.0"
        self.description = "Rest Api Client integration"
        self.executable = "rest-api-client"
