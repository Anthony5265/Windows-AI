"""
LibreTranslate - Production Implementation
Open translation
"""
...
class LibreTranslatePlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["libretranslate", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("LIBRETRANSLATE_API_KEY", "")
        self.base_url = os.getenv("LIBRETRANSLATE_URL", "https://api.libretranslate.com")
