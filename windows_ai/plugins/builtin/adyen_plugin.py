...
class Plugin:
    """Plugin for Adyen integration"""
    
    def __init__(self):
        self.name = "Adyen"
        self.version = "1.0.0"
        self.description = "Adyen integration"
        
        # Configuration
        self.api_key = os.getenv("ADYEN_API_KEY", "")
        self.base_url = "https://api.adyen.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Adyen request
