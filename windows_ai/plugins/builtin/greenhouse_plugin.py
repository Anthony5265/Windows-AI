...
class Plugin:
    """Plugin for Greenhouse integration"""
    
    def __init__(self):
        self.name = "Greenhouse"
        self.version = "1.0.0"
        self.description = "Greenhouse ATS"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Greenhouse"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Greenhouse"""
