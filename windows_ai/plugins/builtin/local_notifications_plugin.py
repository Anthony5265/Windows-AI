"""
Local Notifications Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Local Notifications local integration"""
    
    def __init__(self):
        self.name = "Local Notifications"
        self.version = "1.0.0"
        self.description = "Local Notifications integration"
        self.executable = "local-notifications"
