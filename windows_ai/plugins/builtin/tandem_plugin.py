...
class Plugin:
    """Plugin for Tandem integration"""
    
    def __init__(self):
        self.name = "Tandem"
        self.version = "1.0.0"
        self.description = "Tandem integration"
        
        # Configuration
        self.api_key = os.getenv("TANDEM_API_KEY", "")
        self.base_url = "https://api.tandem.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Tandem request
