...
class Plugin:
    """Plugin for Square integration"""
    
    def __init__(self):
        self.name = "Square"
        self.version = "1.0.0"
        self.description = "Square payments"
        
        # Configuration
        self.api_key = os.getenv("SQUARE_ACCESS_TOKEN", "")
        self.base_url = "https://connect.squareup.com/v2"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Square request
