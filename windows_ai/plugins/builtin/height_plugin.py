"""
Height Plugin - Storage/Database integration
Height task manager
"""
...
class Plugin:
    """Plugin for Height storage"""
    
    def __init__(self):
        self.name = "Height"
        self.version = "1.0.0"
        self.description = "Height task manager"
        self.api_key = os.getenv("HEIGHT_API_KEY", "")
        self.base_url = "https://api.height.app"
