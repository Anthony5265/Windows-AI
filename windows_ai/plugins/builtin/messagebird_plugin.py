...
class Plugin:
    """Plugin for MessageBird integration"""
    
    def __init__(self):
        self.name = "MessageBird"
        self.version = "1.0.0"
        self.description = "MessageBird SMS"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using MessageBird"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using MessageBird"""
