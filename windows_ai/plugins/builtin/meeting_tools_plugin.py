"""
Meeting Tools Plugin - Local Tool Integration
Meeting Tools integration
"""
...
class Plugin:
    """Plugin for Meeting Tools local integration"""
    
    def __init__(self):
        self.name = "Meeting Tools"
        self.version = "1.0.0"
        self.description = "Meeting Tools integration"
        self.executable = "meeting-tools"
