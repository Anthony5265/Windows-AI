...
class Plugin:
    """Plugin for GetResponse integration"""
    
    def __init__(self):
        self.name = "GetResponse"
        self.version = "1.0.0"
        self.description = "GetResponse marketing"
        
        # Configuration
        self.api_key = os.getenv("GETRESPONSE_API_KEY", "")
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using GetResponse"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using GetResponse"""
