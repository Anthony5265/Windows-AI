...
class Plugin:
    """Plugin for Hotjar integration"""
    
    def __init__(self):
        self.name = "Hotjar"
        self.version = "1.0.0"
        self.description = "Hotjar integration"
        
        # Configuration
        self.api_key = os.getenv("HOTJAR_API_KEY", "")
        self.base_url = "https://api.hotjar.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Hotjar request
