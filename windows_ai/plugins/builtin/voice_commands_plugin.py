"""
Voice Commands Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Voice Commands local integration"""
    
    def __init__(self):
        self.name = "Voice Commands"
        self.version = "1.0.0"
        self.description = "Voice Commands integration"
        self.executable = "voice-commands"
