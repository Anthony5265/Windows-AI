"""
Mobile Integration 12 - PRODUCTION
Mobile integration number 12
"""
...
class MobileIntegration12Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="mobile_12",
            name="Mobile Integration 12",
            description="Mobile integration number 12",
            version="2.0.0",
        ...
        self.base_url = "https://api.mobile_12.com"
...
plugin = MobileIntegration12Plugin()
