"""
Mobile Integration 3 - PRODUCTION
Mobile integration number 3
"""
...
class MobileIntegration3Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="mobile_3",
            name="Mobile Integration 3",
            description="Mobile integration number 3",
            version="2.0.0",
        ...
        self.base_url = "https://api.mobile_3.com"
...
plugin = MobileIntegration3Plugin()
