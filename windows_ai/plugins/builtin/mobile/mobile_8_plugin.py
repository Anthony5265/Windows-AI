"""
Mobile Integration 8 - PRODUCTION
Mobile integration number 8
"""
...
class MobileIntegration8Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="mobile_8",
            name="Mobile Integration 8",
            description="Mobile integration number 8",
            version="2.0.0",
        ...
        self.base_url = "https://api.mobile_8.com"
...
plugin = MobileIntegration8Plugin()
