"""
Mobile Integration 1 - PRODUCTION
Mobile integration number 1
"""
...
class MobileIntegration1Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="mobile_1",
            name="Mobile Integration 1",
            description="Mobile integration number 1",
            version="2.0.0",
        ...
        self.base_url = "https://api.mobile_1.com"
...
plugin = MobileIntegration1Plugin()
