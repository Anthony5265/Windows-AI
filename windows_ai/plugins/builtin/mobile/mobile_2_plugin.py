"""
Mobile Integration 2 - PRODUCTION
Mobile integration number 2
"""
...
class MobileIntegration2Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="mobile_2",
            name="Mobile Integration 2",
            description="Mobile integration number 2",
            version="2.0.0",
        ...
        self.base_url = "https://api.mobile_2.com"
...
plugin = MobileIntegration2Plugin()
