"""
Mobile Integration 9 - PRODUCTION
Mobile integration number 9
"""
...
class MobileIntegration9Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="mobile_9",
            name="Mobile Integration 9",
            description="Mobile integration number 9",
            version="2.0.0",
        ...
        self.base_url = "https://api.mobile_9.com"
...
plugin = MobileIntegration9Plugin()
