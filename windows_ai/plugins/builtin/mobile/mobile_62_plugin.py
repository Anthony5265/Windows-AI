"""
Mobile Integration 62 - PRODUCTION
Mobile integration number 62
"""
...
class MobileIntegration62Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="mobile_62",
            name="Mobile Integration 62",
            description="Mobile integration number 62",
            version="2.0.0",
        ...
        self.api_key = os.getenv("MOBILE_62_API_KEY", "")
        self.base_url = "https://api.mobile_62.com"
...
plugin = MobileIntegration62Plugin()
