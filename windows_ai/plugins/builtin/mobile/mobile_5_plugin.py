"""
Mobile Integration 5 - PRODUCTION
Mobile integration number 5
"""
...
class MobileIntegration5Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="mobile_5",
            name="Mobile Integration 5",
            description="Mobile integration number 5",
            version="2.0.0",
        ...
        self.base_url = "https://api.mobile_5.com"
...
plugin = MobileIntegration5Plugin()
