"""
Mobile Integration 4 - PRODUCTION
Mobile integration number 4
"""
...
class MobileIntegration4Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="mobile_4",
            name="Mobile Integration 4",
            description="Mobile integration number 4",
            version="2.0.0",
        ...
        self.base_url = "https://api.mobile_4.com"
...
plugin = MobileIntegration4Plugin()
