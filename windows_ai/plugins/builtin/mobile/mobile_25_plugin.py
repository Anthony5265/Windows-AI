"""
Mobile Integration 25 - PRODUCTION
Mobile integration number 25
"""
...
class MobileIntegration25Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="mobile_25",
            name="Mobile Integration 25",
            description="Mobile integration number 25",
            version="2.0.0",
        ...
        self.api_key = os.getenv("MOBILE_25_API_KEY", "")
        self.base_url = "https://api.mobile_25.com"
...
plugin = MobileIntegration25Plugin()
