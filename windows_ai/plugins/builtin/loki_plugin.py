...
class Plugin:
    """Plugin for Loki integration"""
    
    def __init__(self):
        self.name = "Loki"
        self.version = "1.0.0"
        self.description = "Loki integration"
        
        # Configuration
        self.api_key = os.getenv("LOKI_API_KEY", "")
        self.base_url = "https://api.loki.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Loki request
