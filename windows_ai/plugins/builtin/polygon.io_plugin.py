...
class Plugin:
    """Plugin for Polygon.io integration"""
    
    def __init__(self):
        self.name = "Polygon.io"
        self.version = "1.0.0"
        self.description = "Market data"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Polygon.io"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Polygon.io"""
