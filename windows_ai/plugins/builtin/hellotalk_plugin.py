...
class Plugin:
    """Plugin for Hellotalk integration"""
    
    def __init__(self):
        self.name = "Hellotalk"
        self.version = "1.0.0"
        self.description = "Hellotalk integration"
        
        # Configuration
        self.api_key = os.getenv("HELLOTALK_API_KEY", "")
        self.base_url = "https://api.hellotalk.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Hellotalk request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Hellotalk"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Hellotalk"""
