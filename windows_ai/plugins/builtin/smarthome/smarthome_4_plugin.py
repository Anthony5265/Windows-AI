"""
SmartHome Integration 4 - PRODUCTION
SmartHome integration number 4
"""
...
class SmartHomeIntegration4Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="smarthome_4",
            name="SmartHome Integration 4",
            description="SmartHome integration number 4",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SMARTHOME_4_API_KEY", "")
        self.base_url = "https://api.smarthome_4.com"
...
plugin = SmartHomeIntegration4Plugin()
