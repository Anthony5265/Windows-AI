"""
SmartHome Integration 3 - PRODUCTION
SmartHome integration number 3
"""
...
class SmartHomeIntegration3Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="smarthome_3",
            name="SmartHome Integration 3",
            description="SmartHome integration number 3",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SMARTHOME_3_API_KEY", "")
        self.base_url = "https://api.smarthome_3.com"
...
plugin = SmartHomeIntegration3Plugin()
