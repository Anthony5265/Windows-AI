"""
SmartHome Integration 25 - PRODUCTION
SmartHome integration number 25
"""
...
class SmartHomeIntegration25Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="smarthome_25",
            name="SmartHome Integration 25",
            description="SmartHome integration number 25",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SMARTHOME_25_API_KEY", "")
        self.base_url = "https://api.smarthome_25.com"
...
plugin = SmartHomeIntegration25Plugin()
