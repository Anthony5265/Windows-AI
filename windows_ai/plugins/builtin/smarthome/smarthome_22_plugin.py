"""
SmartHome Integration 22 - PRODUCTION
SmartHome integration number 22
"""
...
class SmartHomeIntegration22Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="smarthome_22",
            name="SmartHome Integration 22",
            description="SmartHome integration number 22",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SMARTHOME_22_API_KEY", "")
        self.base_url = "https://api.smarthome_22.com"
...
plugin = SmartHomeIntegration22Plugin()
