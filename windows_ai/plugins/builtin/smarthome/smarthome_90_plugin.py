"""
SmartHome Integration 90 - PRODUCTION
SmartHome integration number 90
"""
...
class SmartHomeIntegration90Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="smarthome_90",
            name="SmartHome Integration 90",
            description="SmartHome integration number 90",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SMARTHOME_90_API_KEY", "")
        self.base_url = "https://api.smarthome_90.com"
...
plugin = SmartHomeIntegration90Plugin()
