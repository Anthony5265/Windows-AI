"""
SmartHome Integration 1 - PRODUCTION
SmartHome integration number 1
"""
...
class SmartHomeIntegration1Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="smarthome_1",
            name="SmartHome Integration 1",
            description="SmartHome integration number 1",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SMARTHOME_1_API_KEY", "")
        self.base_url = "https://api.smarthome_1.com"
...
plugin = SmartHomeIntegration1Plugin()
