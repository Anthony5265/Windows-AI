"""
SmartHome Integration 125 - PRODUCTION
SmartHome integration number 125
"""
...
class SmartHomeIntegration125Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="smarthome_125",
            name="SmartHome Integration 125",
            description="SmartHome integration number 125",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SMARTHOME_125_API_KEY", "")
        self.base_url = "https://api.smarthome_125.com"
...
plugin = SmartHomeIntegration125Plugin()
