"""
SmartHome Integration 2 - PRODUCTION
SmartHome integration number 2
"""
...
class SmartHomeIntegration2Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="smarthome_2",
            name="SmartHome Integration 2",
            description="SmartHome integration number 2",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SMARTHOME_2_API_KEY", "")
        self.base_url = "https://api.smarthome_2.com"
...
plugin = SmartHomeIntegration2Plugin()
