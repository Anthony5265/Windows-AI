"""
SmartHome Integration 26 - PRODUCTION
SmartHome integration number 26
"""
...
class SmartHomeIntegration26Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="smarthome_26",
            name="SmartHome Integration 26",
            description="SmartHome integration number 26",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SMARTHOME_26_API_KEY", "")
        self.base_url = "https://api.smarthome_26.com"
...
plugin = SmartHomeIntegration26Plugin()
