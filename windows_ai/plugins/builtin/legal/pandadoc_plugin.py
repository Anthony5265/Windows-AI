"""
PandaDoc - Production Implementation
Document automation
"""
...
class PandaDocPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["pandadoc", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("PANDADOC_API_KEY", "")
        self.base_url = os.getenv("PANDADOC_URL", "https://api.pandadoc.com")
