"""
Adobe Sign - Production Implementation
E-signature service
"""
...
class AdobeSignPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["adobe_sign", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("ADOBE_SIGN_API_KEY", "")
        self.base_url = os.getenv("ADOBE_SIGN_URL", "https://api.adobe_sign.com")
