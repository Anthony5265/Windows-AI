"""
DocuSign - Production Implementation
E-signatures
"""
...
class DocuSignPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["docusign", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("DOCUSIGN_API_KEY", "")
        self.base_url = os.getenv("DOCUSIGN_URL", "https://api.docusign.com")
