...
class WindowsHyper-VPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="windows_hyper-v",
            name="Windows Hyper-V",
            description="Windows Hyper-V integration with full API support",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["windows", "os", "hyper-v"]
        )
