...
class WindowsEventLogPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="windows_event_log",
            name="Windows Event Log",
            description="Windows Event Log integration with full API support",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["windows", "os", "event_log"]
        )
