...
class Plugin:
    """Plugin for Trello integration"""
    
    def __init__(self):
        self.name = "Trello"
        self.version = "1.0.0"
        self.description = "Trello project management"
