...
class Plugin:
    """Plugin for Sisense integration"""
    
    def __init__(self):
        self.name = "Sisense"
        self.version = "1.0.0"
        self.description = "Sisense integration"
        
        # Configuration
        self.api_key = os.getenv("SISENSE_API_KEY", "")
        self.base_url = "https://api.sisense.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Sisense request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Sisense"""
