"""
Apple Calendar Plugin - Local Tool Integration
macOS Calendar via CalDAV
"""
...
class Plugin:
    """Plugin for Apple Calendar local integration"""
    
    def __init__(self):
        self.name = "Apple Calendar"
        self.version = "1.0.0"
        self.description = "macOS Calendar via CalDAV"
