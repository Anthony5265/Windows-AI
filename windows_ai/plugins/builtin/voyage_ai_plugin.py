...
class Plugin:
    """Plugin for Voyage Ai integration"""
    
    def __init__(self):
        self.name = "Voyage Ai"
        self.version = "1.0.0"
        self.description = "Voyage Ai integration"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Voyage Ai"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Voyage Ai"""
