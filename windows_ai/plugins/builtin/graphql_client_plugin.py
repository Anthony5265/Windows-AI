"""
Graphql Client Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Graphql Client local integration"""
    
    def __init__(self):
        self.name = "Graphql Client"
        self.version = "1.0.0"
        self.description = "Graphql Client integration"
        self.executable = "graphql-client"
