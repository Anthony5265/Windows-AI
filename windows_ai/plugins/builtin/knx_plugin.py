...
class Plugin:
    """Plugin for Knx integration"""
    
    def __init__(self):
        self.name = "Knx"
        self.version = "1.0.0"
        self.description = "Knx integration"
        
        # Configuration
        self.api_key = os.getenv("KNX_API_KEY", "")
        self.base_url = "https://api.knx.com/v1"
        self.timeout = 30
