...
class Plugin:
    """Plugin for Xero integration"""
    
    def __init__(self):
        self.name = "Xero"
        self.version = "1.0.0"
        self.description = "Xero accounting"
        
        # Configuration
        self.api_key = os.getenv("XERO_ACCESS_TOKEN", "")
        self.base_url = "https://api.xero.com/api.xro/2.0"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Xero request
