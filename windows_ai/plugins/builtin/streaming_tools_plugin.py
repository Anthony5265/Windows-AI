"""
Streaming Tools Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Streaming Tools local integration"""
    
    def __init__(self):
        self.name = "Streaming Tools"
        self.version = "1.0.0"
        self.description = "Streaming Tools integration"
        self.executable = "streaming-tools"
