"""
Langchain Local Models Plugin - Local Tool Integration
Langchain Local Models integration
"""
...
class Plugin:
    """Plugin for Langchain Local Models local integration"""
    
    def __init__(self):
        self.name = "Langchain Local Models"
        self.version = "1.0.0"
        self.description = "Langchain Local Models integration"
        self.executable = "langchain-local-models"
