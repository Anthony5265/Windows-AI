...
class Plugin:
    """Plugin for Ubidots integration"""
    
    def __init__(self):
        self.name = "Ubidots"
        self.version = "1.0.0"
        self.description = "Ubidots integration"
        
        # Configuration
        self.api_key = os.getenv("UBIDOTS_API_KEY", "")
        self.base_url = "https://api.ubidots.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Ubidots request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Ubidots"""
