...
class Plugin:
    """Plugin for Curseforge integration"""
    
    def __init__(self):
        self.name = "Curseforge"
        self.version = "1.0.0"
        self.description = "Curseforge integration"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Curseforge"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Curseforge"""
