...
class Plugin:
    """Plugin for Mondaycom integration"""
    
    def __init__(self):
        self.name = "Mondaycom"
        self.version = "1.0.0"
        self.description = "Mondaycom integration"
        
        # Configuration
        self.api_key = os.getenv("MONDAYCOM_API_KEY", "")
        self.base_url = "https://api.mondaycom.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Mondaycom request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Mondaycom"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Mondaycom"""
