...
class Plugin:
    """Plugin for Prompt Injection Defense integration"""
    
    def __init__(self):
        self.name = "Prompt Injection Defense"
        self.version = "1.0.0"
        self.description = "Prompt Injection Defense integration"
        
        # Configuration
        self.api_key = os.getenv("PROMPT_INJECTION_DEFENSE_API_KEY", "")
        self.base_url = "https://api.promptinjectiondefense.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Prompt Injection Defense request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Prompt Injection Defense"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Prompt Injection Defense"""
