"""
Health Integration 1 - PRODUCTION
Health integration number 1
"""
...
class HealthIntegration1Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="health_1",
            name="Health Integration 1",
            description="Health integration number 1",
            version="2.0.0",
        ...
        self.api_key = os.getenv("HEALTH_1_API_KEY", "")
        self.base_url = "https://api.health_1.com"
...
plugin = HealthIntegration1Plugin()
