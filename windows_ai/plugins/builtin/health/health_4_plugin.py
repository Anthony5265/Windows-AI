"""
Health Integration 4 - PRODUCTION
Health integration number 4
"""
...
class HealthIntegration4Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="health_4",
            name="Health Integration 4",
            description="Health integration number 4",
            version="2.0.0",
        ...
        self.api_key = os.getenv("HEALTH_4_API_KEY", "")
        self.base_url = "https://api.health_4.com"
...
plugin = HealthIntegration4Plugin()
