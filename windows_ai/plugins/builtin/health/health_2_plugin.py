"""
Health Integration 2 - PRODUCTION
Health integration number 2
"""
...
class HealthIntegration2Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="health_2",
            name="Health Integration 2",
            description="Health integration number 2",
            version="2.0.0",
        ...
        self.api_key = os.getenv("HEALTH_2_API_KEY", "")
        self.base_url = "https://api.health_2.com"
...
plugin = HealthIntegration2Plugin()
