...
class Plugin:
    """Plugin for Transcription integration"""
    
    def __init__(self):
        self.name = "Transcription"
        self.version = "1.0.0"
        self.description = "Transcription integration"
        
        # Configuration
        self.api_key = os.getenv("TRANSCRIPTION_API_KEY", "")
        self.base_url = "https://api.transcription.com/v1"
        self.timeout = 30
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Transcription"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Transcription"""
