...
class Plugin:
    """Plugin for Plaid integration"""
    
    def __init__(self):
        self.name = "Plaid"
        self.version = "1.0.0"
        self.description = "Plaid banking"
        
        # Configuration
        self.api_key = os.getenv("PLAID_CLIENT_ID", "")
