...
class Plugin:
    """Plugin for Closeio integration"""
    
    def __init__(self):
        self.name = "Closeio"
        self.version = "1.0.0"
        self.description = "Closeio integration"
        
        # Configuration
        self.api_key = os.getenv("CLOSEIO_API_KEY", "")
        self.base_url = "https://api.closeio.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Closeio request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Closeio"""
