"""
Text Generation WebUI Plugin - Local Tool Integration
oobabooga gradio interface
"""
...
class Plugin:
    """Plugin for Text Generation WebUI local integration"""
    
    def __init__(self):
        self.name = "Text Generation WebUI"
        self.version = "1.0.0"
        self.description = "oobabooga gradio interface"
