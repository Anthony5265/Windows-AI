"""
Nativescript Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Nativescript local integration"""
    
    def __init__(self):
        self.name = "Nativescript"
        self.version = "1.0.0"
        self.description = "Nativescript integration"
        self.executable = "nativescript"
