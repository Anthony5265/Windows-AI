"""
Localization L10N Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Localization L10N local integration"""
    
    def __init__(self):
        self.name = "Localization L10N"
        self.version = "1.0.0"
        self.description = "Localization L10N integration"
        self.executable = "localization-l10n"
