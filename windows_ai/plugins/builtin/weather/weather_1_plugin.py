"""
Weather Tool 1 - Production Implementation
...
class WeatherTool1Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="weather_1",
            name="Weather Tool 1",
            description="Weather/environment 1",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["weather_1", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("WEATHER_1_API_KEY", "")
        self.base_url = os.getenv("WEATHER_1_URL", "https://api.weather_1.com")
