"""
Weather Tool 4 - Production Implementation
...
class WeatherTool4Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="weather_4",
            name="Weather Tool 4",
            description="Weather/environment 4",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["weather_4", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("WEATHER_4_API_KEY", "")
        self.base_url = os.getenv("WEATHER_4_URL", "https://api.weather_4.com")
