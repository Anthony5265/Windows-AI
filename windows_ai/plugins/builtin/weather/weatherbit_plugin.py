"""
Weatherbit - Production Implementation
Weather data
"""
...
class WeatherbitPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["weatherbit", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("WEATHERBIT_API_KEY", "")
        self.base_url = os.getenv("WEATHERBIT_URL", "https://api.weatherbit.com")
