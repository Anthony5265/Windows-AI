"""
AccuWeather - Production Implementation
Weather service
"""
...
class AccuWeatherPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["accuweather", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("ACCUWEATHER_API_KEY", "")
        self.base_url = os.getenv("ACCUWEATHER_URL", "https://api.accuweather.com")
