"""
1Password - Production Implementation
Password manager
"""
...
class 1PasswordPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["onepassword", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("ONEPASSWORD_API_KEY", "")
        self.base_url = os.getenv("ONEPASSWORD_URL", "https://api.onepassword.com")
