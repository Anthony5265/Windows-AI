...
class Plugin:
    """Plugin for Playht integration"""
    
    def __init__(self):
        self.name = "Playht"
        self.version = "1.0.0"
        self.description = "Playht integration"
        
        # Configuration
        self.api_key = os.getenv("PLAYHT_API_KEY", "")
        self.base_url = "https://api.playht.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Playht request
