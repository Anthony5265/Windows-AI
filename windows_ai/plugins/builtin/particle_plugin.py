...
class Plugin:
    """Plugin for Particle integration"""
    
    def __init__(self):
        self.name = "Particle"
        self.version = "1.0.0"
        self.description = "Particle integration"
        
        # Configuration
        self.api_key = os.getenv("PARTICLE_API_KEY", "")
        self.base_url = "https://api.particle.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Particle request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Particle"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Particle"""
