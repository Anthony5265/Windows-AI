...
class Plugin:
    """Plugin for Containers integration"""
    
    def __init__(self):
        self.name = "Containers"
        self.version = "1.0.0"
        self.description = "Containers integration"
        
        # Configuration
        self.api_key = os.getenv("CONTAINERS_API_KEY", "")
        self.base_url = "https://api.containers.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Containers request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Containers"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Containers"""
