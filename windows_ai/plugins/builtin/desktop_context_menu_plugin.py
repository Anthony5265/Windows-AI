"""
Desktop Context Menu Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Desktop Context Menu local integration"""
    
    def __init__(self):
        self.name = "Desktop Context Menu"
        self.version = "1.0.0"
        self.description = "Desktop Context Menu integration"
        self.executable = "desktop-context-menu"
