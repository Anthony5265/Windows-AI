...
class Plugin:
    """Plugin for When2Meet integration"""
    
    def __init__(self):
        self.name = "When2Meet"
        self.version = "1.0.0"
        self.description = "When2Meet integration"
        
        # Configuration
        self.api_key = os.getenv("WHEN2MEET_API_KEY", "")
        self.base_url = "https://api.when2meet.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute When2Meet request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using When2Meet"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using When2Meet"""
