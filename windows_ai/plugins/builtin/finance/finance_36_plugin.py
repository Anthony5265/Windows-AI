"""
Finance Integration 36 - PRODUCTION
Finance integration number 36
"""
...
class FinanceIntegration36Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_36",
            name="Finance Integration 36",
            description="Finance integration number 36",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_36_API_KEY", "")
        self.base_url = "https://api.finance_36.com"
...
plugin = FinanceIntegration36Plugin()
