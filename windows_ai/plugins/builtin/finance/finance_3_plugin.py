"""
Finance Integration 3 - PRODUCTION
Finance integration number 3
"""
...
class FinanceIntegration3Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_3",
            name="Finance Integration 3",
            description="Finance integration number 3",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_3_API_KEY", "")
        self.base_url = "https://api.finance_3.com"
...
plugin = FinanceIntegration3Plugin()
