"""
Finance Integration 21 - PRODUCTION
Finance integration number 21
"""
...
class FinanceIntegration21Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_21",
            name="Finance Integration 21",
            description="Finance integration number 21",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_21_API_KEY", "")
        self.base_url = "https://api.finance_21.com"
...
plugin = FinanceIntegration21Plugin()
