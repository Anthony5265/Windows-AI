"""
Finance Integration 1 - PRODUCTION
Finance integration number 1
"""
...
class FinanceIntegration1Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_1",
            name="Finance Integration 1",
            description="Finance integration number 1",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_1_API_KEY", "")
        self.base_url = "https://api.finance_1.com"
...
plugin = FinanceIntegration1Plugin()
