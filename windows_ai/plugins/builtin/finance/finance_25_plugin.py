"""
Finance Integration 25 - PRODUCTION
Finance integration number 25
"""
...
class FinanceIntegration25Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_25",
            name="Finance Integration 25",
            description="Finance integration number 25",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_25_API_KEY", "")
        self.base_url = "https://api.finance_25.com"
...
plugin = FinanceIntegration25Plugin()
