"""
Finance Integration 2 - PRODUCTION
Finance integration number 2
"""
...
class FinanceIntegration2Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_2",
            name="Finance Integration 2",
            description="Finance integration number 2",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_2_API_KEY", "")
        self.base_url = "https://api.finance_2.com"
...
plugin = FinanceIntegration2Plugin()
