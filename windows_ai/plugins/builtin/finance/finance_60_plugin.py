"""
Finance Integration 60 - PRODUCTION
Finance integration number 60
"""
...
class FinanceIntegration60Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_60",
            name="Finance Integration 60",
            description="Finance integration number 60",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_60_API_KEY", "")
        self.base_url = "https://api.finance_60.com"
...
plugin = FinanceIntegration60Plugin()
