"""
Finance Integration 20 - PRODUCTION
Finance integration number 20
"""
...
class FinanceIntegration20Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_20",
            name="Finance Integration 20",
            description="Finance integration number 20",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_20_API_KEY", "")
        self.base_url = "https://api.finance_20.com"
...
plugin = FinanceIntegration20Plugin()
