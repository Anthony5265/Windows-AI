"""
Finance Integration 26 - PRODUCTION
Finance integration number 26
"""
...
class FinanceIntegration26Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_26",
            name="Finance Integration 26",
            description="Finance integration number 26",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_26_API_KEY", "")
        self.base_url = "https://api.finance_26.com"
...
plugin = FinanceIntegration26Plugin()
