"""
Finance Integration 37 - PRODUCTION
Finance integration number 37
"""
...
class FinanceIntegration37Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_37",
            name="Finance Integration 37",
            description="Finance integration number 37",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_37_API_KEY", "")
        self.base_url = "https://api.finance_37.com"
...
plugin = FinanceIntegration37Plugin()
