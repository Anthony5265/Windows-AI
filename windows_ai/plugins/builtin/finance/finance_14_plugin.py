"""
Finance Integration 14 - PRODUCTION
Finance integration number 14
"""
...
class FinanceIntegration14Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_14",
            name="Finance Integration 14",
            description="Finance integration number 14",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_14_API_KEY", "")
        self.base_url = "https://api.finance_14.com"
...
plugin = FinanceIntegration14Plugin()
