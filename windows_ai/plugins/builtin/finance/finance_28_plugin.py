"""
Finance Integration 28 - PRODUCTION
Finance integration number 28
"""
...
class FinanceIntegration28Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_28",
            name="Finance Integration 28",
            description="Finance integration number 28",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_28_API_KEY", "")
        self.base_url = "https://api.finance_28.com"
...
plugin = FinanceIntegration28Plugin()
