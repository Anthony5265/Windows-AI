"""
Finance Integration 8 - PRODUCTION
Finance integration number 8
"""
...
class FinanceIntegration8Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_8",
            name="Finance Integration 8",
            description="Finance integration number 8",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_8_API_KEY", "")
        self.base_url = "https://api.finance_8.com"
...
plugin = FinanceIntegration8Plugin()
