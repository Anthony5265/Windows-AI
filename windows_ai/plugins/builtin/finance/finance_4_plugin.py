"""
Finance Integration 4 - PRODUCTION
Finance integration number 4
"""
...
class FinanceIntegration4Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_4",
            name="Finance Integration 4",
            description="Finance integration number 4",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_4_API_KEY", "")
        self.base_url = "https://api.finance_4.com"
...
plugin = FinanceIntegration4Plugin()
