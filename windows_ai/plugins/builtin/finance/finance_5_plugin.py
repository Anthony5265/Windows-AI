"""
Finance Integration 5 - PRODUCTION
Finance integration number 5
"""
...
class FinanceIntegration5Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_5",
            name="Finance Integration 5",
            description="Finance integration number 5",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_5_API_KEY", "")
        self.base_url = "https://api.finance_5.com"
...
plugin = FinanceIntegration5Plugin()
