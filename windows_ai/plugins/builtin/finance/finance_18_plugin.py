"""
Finance Integration 18 - PRODUCTION
Finance integration number 18
"""
...
class FinanceIntegration18Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_18",
            name="Finance Integration 18",
            description="Finance integration number 18",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_18_API_KEY", "")
        self.base_url = "https://api.finance_18.com"
...
plugin = FinanceIntegration18Plugin()
