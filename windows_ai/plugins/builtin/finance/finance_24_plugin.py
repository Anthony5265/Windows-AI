"""
Finance Integration 24 - PRODUCTION
Finance integration number 24
"""
...
class FinanceIntegration24Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_24",
            name="Finance Integration 24",
            description="Finance integration number 24",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_24_API_KEY", "")
        self.base_url = "https://api.finance_24.com"
...
plugin = FinanceIntegration24Plugin()
