"""
Finance Integration 22 - PRODUCTION
Finance integration number 22
"""
...
class FinanceIntegration22Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_22",
            name="Finance Integration 22",
            description="Finance integration number 22",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_22_API_KEY", "")
        self.base_url = "https://api.finance_22.com"
...
plugin = FinanceIntegration22Plugin()
