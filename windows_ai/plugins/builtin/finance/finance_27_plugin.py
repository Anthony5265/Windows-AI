"""
Finance Integration 27 - PRODUCTION
Finance integration number 27
"""
...
class FinanceIntegration27Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_27",
            name="Finance Integration 27",
            description="Finance integration number 27",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_27_API_KEY", "")
        self.base_url = "https://api.finance_27.com"
...
plugin = FinanceIntegration27Plugin()
