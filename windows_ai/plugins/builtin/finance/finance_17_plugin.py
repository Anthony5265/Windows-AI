"""
Finance Integration 17 - PRODUCTION
Finance integration number 17
"""
...
class FinanceIntegration17Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_17",
            name="Finance Integration 17",
            description="Finance integration number 17",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_17_API_KEY", "")
        self.base_url = "https://api.finance_17.com"
...
plugin = FinanceIntegration17Plugin()
