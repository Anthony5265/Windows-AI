"""
Finance Integration 12 - PRODUCTION
Finance integration number 12
"""
...
class FinanceIntegration12Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_12",
            name="Finance Integration 12",
            description="Finance integration number 12",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_12_API_KEY", "")
        self.base_url = "https://api.finance_12.com"
...
plugin = FinanceIntegration12Plugin()
