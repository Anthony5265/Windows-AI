"""
Finance Integration 13 - PRODUCTION
Finance integration number 13
"""
...
class FinanceIntegration13Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="finance_13",
            name="Finance Integration 13",
            description="Finance integration number 13",
            version="2.0.0",
        ...
        self.api_key = os.getenv("FINANCE_13_API_KEY", "")
        self.base_url = "https://api.finance_13.com"
...
plugin = FinanceIntegration13Plugin()
