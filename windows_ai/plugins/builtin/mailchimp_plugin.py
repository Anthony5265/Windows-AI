...
class Plugin:
    """Plugin for Mailchimp integration"""
    
    def __init__(self):
        self.name = "Mailchimp"
        self.version = "1.0.0"
        self.description = "Mailchimp marketing"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Mailchimp"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Mailchimp"""
