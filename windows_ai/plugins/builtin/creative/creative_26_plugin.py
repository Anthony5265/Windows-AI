"""
Creative Integration 26 - PRODUCTION
Creative integration number 26
"""
...
class CreativeIntegration26Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_26",
            name="Creative Integration 26",
            description="Creative integration number 26",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_26_API_KEY", "")
        self.base_url = "https://api.creative_26.com"
...
plugin = CreativeIntegration26Plugin()
