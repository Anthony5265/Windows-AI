"""
Creative Integration 18 - PRODUCTION
Creative integration number 18
"""
...
class CreativeIntegration18Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_18",
            name="Creative Integration 18",
            description="Creative integration number 18",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_18_API_KEY", "")
        self.base_url = "https://api.creative_18.com"
...
plugin = CreativeIntegration18Plugin()
