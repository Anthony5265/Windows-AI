"""
Creative Integration 28 - PRODUCTION
Creative integration number 28
"""
...
class CreativeIntegration28Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_28",
            name="Creative Integration 28",
            description="Creative integration number 28",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_28_API_KEY", "")
        self.base_url = "https://api.creative_28.com"
...
plugin = CreativeIntegration28Plugin()
