"""
Creative Integration 27 - PRODUCTION
Creative integration number 27
"""
...
class CreativeIntegration27Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_27",
            name="Creative Integration 27",
            description="Creative integration number 27",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_27_API_KEY", "")
        self.base_url = "https://api.creative_27.com"
...
plugin = CreativeIntegration27Plugin()
