"""
Creative Integration 36 - PRODUCTION
Creative integration number 36
"""
...
class CreativeIntegration36Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_36",
            name="Creative Integration 36",
            description="Creative integration number 36",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_36_API_KEY", "")
        self.base_url = "https://api.creative_36.com"
...
plugin = CreativeIntegration36Plugin()
