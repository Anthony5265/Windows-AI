"""
Creative Integration 25 - PRODUCTION
Creative integration number 25
"""
...
class CreativeIntegration25Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_25",
            name="Creative Integration 25",
            description="Creative integration number 25",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_25_API_KEY", "")
        self.base_url = "https://api.creative_25.com"
...
plugin = CreativeIntegration25Plugin()
