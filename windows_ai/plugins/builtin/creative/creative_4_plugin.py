"""
Creative Integration 4 - PRODUCTION
Creative integration number 4
"""
...
class CreativeIntegration4Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_4",
            name="Creative Integration 4",
            description="Creative integration number 4",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_4_API_KEY", "")
        self.base_url = "https://api.creative_4.com"
...
plugin = CreativeIntegration4Plugin()
