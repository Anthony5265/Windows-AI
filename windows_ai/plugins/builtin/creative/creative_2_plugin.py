"""
Creative Integration 2 - PRODUCTION
Creative integration number 2
"""
...
class CreativeIntegration2Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_2",
            name="Creative Integration 2",
            description="Creative integration number 2",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_2_API_KEY", "")
        self.base_url = "https://api.creative_2.com"
...
plugin = CreativeIntegration2Plugin()
