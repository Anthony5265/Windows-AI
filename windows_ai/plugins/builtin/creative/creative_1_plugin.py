"""
Creative Integration 1 - PRODUCTION
Creative integration number 1
"""
...
class CreativeIntegration1Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_1",
            name="Creative Integration 1",
            description="Creative integration number 1",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_1_API_KEY", "")
        self.base_url = "https://api.creative_1.com"
...
plugin = CreativeIntegration1Plugin()
