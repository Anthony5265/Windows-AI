"""
Creative Integration 13 - PRODUCTION
Creative integration number 13
"""
...
class CreativeIntegration13Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_13",
            name="Creative Integration 13",
            description="Creative integration number 13",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_13_API_KEY", "")
        self.base_url = "https://api.creative_13.com"
...
plugin = CreativeIntegration13Plugin()
