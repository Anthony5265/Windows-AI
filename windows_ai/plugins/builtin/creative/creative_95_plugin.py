"""
Creative Integration 95 - PRODUCTION
Creative integration number 95
"""
...
class CreativeIntegration95Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_95",
            name="Creative Integration 95",
            description="Creative integration number 95",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_95_API_KEY", "")
        self.base_url = "https://api.creative_95.com"
...
plugin = CreativeIntegration95Plugin()
