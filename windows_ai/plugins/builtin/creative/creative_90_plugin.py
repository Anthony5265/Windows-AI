"""
Creative Integration 90 - PRODUCTION
Creative integration number 90
"""
...
class CreativeIntegration90Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_90",
            name="Creative Integration 90",
            description="Creative integration number 90",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_90_API_KEY", "")
        self.base_url = "https://api.creative_90.com"
...
plugin = CreativeIntegration90Plugin()
