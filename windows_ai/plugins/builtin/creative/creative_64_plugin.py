"""
Creative Integration 64 - PRODUCTION
Creative integration number 64
"""
...
class CreativeIntegration64Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_64",
            name="Creative Integration 64",
            description="Creative integration number 64",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_64_API_KEY", "")
        self.base_url = "https://api.creative_64.com"
...
plugin = CreativeIntegration64Plugin()
