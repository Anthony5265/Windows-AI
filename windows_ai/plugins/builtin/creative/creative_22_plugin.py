"""
Creative Integration 22 - PRODUCTION
Creative integration number 22
"""
...
class CreativeIntegration22Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_22",
            name="Creative Integration 22",
            description="Creative integration number 22",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_22_API_KEY", "")
        self.base_url = "https://api.creative_22.com"
...
plugin = CreativeIntegration22Plugin()
