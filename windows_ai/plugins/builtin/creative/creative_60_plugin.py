"""
Creative Integration 60 - PRODUCTION
Creative integration number 60
"""
...
class CreativeIntegration60Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_60",
            name="Creative Integration 60",
            description="Creative integration number 60",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_60_API_KEY", "")
        self.base_url = "https://api.creative_60.com"
...
plugin = CreativeIntegration60Plugin()
