"""
Creative Integration 96 - PRODUCTION
Creative integration number 96
"""
...
class CreativeIntegration96Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_96",
            name="Creative Integration 96",
            description="Creative integration number 96",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_96_API_KEY", "")
        self.base_url = "https://api.creative_96.com"
...
plugin = CreativeIntegration96Plugin()
