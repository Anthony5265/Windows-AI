"""
Creative Integration 21 - PRODUCTION
Creative integration number 21
"""
...
class CreativeIntegration21Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_21",
            name="Creative Integration 21",
            description="Creative integration number 21",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_21_API_KEY", "")
        self.base_url = "https://api.creative_21.com"
...
plugin = CreativeIntegration21Plugin()
