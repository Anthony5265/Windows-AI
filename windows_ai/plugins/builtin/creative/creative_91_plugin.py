"""
Creative Integration 91 - PRODUCTION
Creative integration number 91
"""
...
class CreativeIntegration91Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_91",
            name="Creative Integration 91",
            description="Creative integration number 91",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_91_API_KEY", "")
        self.base_url = "https://api.creative_91.com"
...
plugin = CreativeIntegration91Plugin()
