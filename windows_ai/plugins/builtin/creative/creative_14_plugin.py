"""
Creative Integration 14 - PRODUCTION
Creative integration number 14
"""
...
class CreativeIntegration14Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="creative_14",
            name="Creative Integration 14",
            description="Creative integration number 14",
            version="2.0.0",
        ...
        self.api_key = os.getenv("CREATIVE_14_API_KEY", "")
        self.base_url = "https://api.creative_14.com"
...
plugin = CreativeIntegration14Plugin()
