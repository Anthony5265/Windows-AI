...
class Plugin:
    """Plugin for Sigfox integration"""
    
    def __init__(self):
        self.name = "Sigfox"
        self.version = "1.0.0"
        self.description = "Sigfox integration"
        
        # Configuration
        self.api_key = os.getenv("SIGFOX_API_KEY", "")
        self.base_url = "https://api.sigfox.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Sigfox request
