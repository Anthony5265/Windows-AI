...
class Plugin:
    """Plugin for Pin integration"""
    
    def __init__(self):
        self.name = "Pin"
        self.version = "1.0.0"
        self.description = "Pin integration"
        
        # Configuration
        self.api_key = os.getenv("PIN_API_KEY", "")
        self.base_url = "https://api.pin.com/v1"
        self.timeout = 30
