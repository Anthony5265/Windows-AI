...
class Plugin:
    """Plugin for Thread integration"""
    
    def __init__(self):
        self.name = "Thread"
        self.version = "1.0.0"
        self.description = "Thread integration"
        
        # Configuration
        self.api_key = os.getenv("THREAD_API_KEY", "")
