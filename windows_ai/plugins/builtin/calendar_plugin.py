...
class Plugin:
    """Plugin for Calendar integration"""
    
    def __init__(self):
        self.name = "Calendar"
        self.version = "1.0.0"
        self.description = "Calendar integration"
        
        # Configuration
        self.api_key = os.getenv("CALENDAR_API_KEY", "")
        self.base_url = "https://api.calendar.com/v1"
        self.timeout = 30
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Calendar"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Calendar"""
