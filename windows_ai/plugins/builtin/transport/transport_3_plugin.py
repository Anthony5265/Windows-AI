"""
Transportation Integration 3 - PRODUCTION
Transportation integration number 3
"""
...
class TransportationIntegration3Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_3",
            name="Transportation Integration 3",
            description="Transportation integration number 3",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_3_API_KEY", "")
        self.base_url = "https://api.transport_3.com"
...
plugin = TransportationIntegration3Plugin()
