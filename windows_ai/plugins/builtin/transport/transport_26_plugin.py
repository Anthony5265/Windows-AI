"""
Transportation Integration 26 - PRODUCTION
Transportation integration number 26
"""
...
class TransportationIntegration26Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_26",
            name="Transportation Integration 26",
            description="Transportation integration number 26",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_26_API_KEY", "")
        self.base_url = "https://api.transport_26.com"
...
plugin = TransportationIntegration26Plugin()
