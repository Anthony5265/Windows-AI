"""
Transportation Integration 4 - PRODUCTION
Transportation integration number 4
"""
...
class TransportationIntegration4Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_4",
            name="Transportation Integration 4",
            description="Transportation integration number 4",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_4_API_KEY", "")
        self.base_url = "https://api.transport_4.com"
...
plugin = TransportationIntegration4Plugin()
