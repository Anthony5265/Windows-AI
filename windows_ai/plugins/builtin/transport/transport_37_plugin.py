"""
Transportation Integration 37 - PRODUCTION
Transportation integration number 37
"""
...
class TransportationIntegration37Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_37",
            name="Transportation Integration 37",
            description="Transportation integration number 37",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_37_API_KEY", "")
        self.base_url = "https://api.transport_37.com"
...
plugin = TransportationIntegration37Plugin()
