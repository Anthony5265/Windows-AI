"""
Transportation Integration 21 - PRODUCTION
Transportation integration number 21
"""
...
class TransportationIntegration21Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_21",
            name="Transportation Integration 21",
            description="Transportation integration number 21",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_21_API_KEY", "")
        self.base_url = "https://api.transport_21.com"
...
plugin = TransportationIntegration21Plugin()
