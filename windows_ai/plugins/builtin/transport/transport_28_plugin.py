"""
Transportation Integration 28 - PRODUCTION
Transportation integration number 28
"""
...
class TransportationIntegration28Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_28",
            name="Transportation Integration 28",
            description="Transportation integration number 28",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_28_API_KEY", "")
        self.base_url = "https://api.transport_28.com"
...
plugin = TransportationIntegration28Plugin()
