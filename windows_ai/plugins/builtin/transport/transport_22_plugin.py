"""
Transportation Integration 22 - PRODUCTION
Transportation integration number 22
"""
...
class TransportationIntegration22Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_22",
            name="Transportation Integration 22",
            description="Transportation integration number 22",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_22_API_KEY", "")
        self.base_url = "https://api.transport_22.com"
...
plugin = TransportationIntegration22Plugin()
