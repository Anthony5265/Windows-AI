"""
Transportation Integration 8 - PRODUCTION
Transportation integration number 8
"""
...
class TransportationIntegration8Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_8",
            name="Transportation Integration 8",
            description="Transportation integration number 8",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_8_API_KEY", "")
        self.base_url = "https://api.transport_8.com"
...
plugin = TransportationIntegration8Plugin()
