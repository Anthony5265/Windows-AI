"""
Transportation Integration 36 - PRODUCTION
Transportation integration number 36
"""
...
class TransportationIntegration36Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_36",
            name="Transportation Integration 36",
            description="Transportation integration number 36",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_36_API_KEY", "")
        self.base_url = "https://api.transport_36.com"
...
plugin = TransportationIntegration36Plugin()
