"""
Transportation Integration 14 - PRODUCTION
Transportation integration number 14
"""
...
class TransportationIntegration14Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_14",
            name="Transportation Integration 14",
            description="Transportation integration number 14",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_14_API_KEY", "")
        self.base_url = "https://api.transport_14.com"
...
plugin = TransportationIntegration14Plugin()
