"""
Transportation Integration 25 - PRODUCTION
Transportation integration number 25
"""
...
class TransportationIntegration25Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_25",
            name="Transportation Integration 25",
            description="Transportation integration number 25",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_25_API_KEY", "")
        self.base_url = "https://api.transport_25.com"
...
plugin = TransportationIntegration25Plugin()
