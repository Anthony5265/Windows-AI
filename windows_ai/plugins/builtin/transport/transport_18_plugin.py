"""
Transportation Integration 18 - PRODUCTION
Transportation integration number 18
"""
...
class TransportationIntegration18Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_18",
            name="Transportation Integration 18",
            description="Transportation integration number 18",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_18_API_KEY", "")
        self.base_url = "https://api.transport_18.com"
...
plugin = TransportationIntegration18Plugin()
