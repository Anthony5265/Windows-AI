"""
Transportation Integration 1 - PRODUCTION
Transportation integration number 1
"""
...
class TransportationIntegration1Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_1",
            name="Transportation Integration 1",
            description="Transportation integration number 1",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_1_API_KEY", "")
        self.base_url = "https://api.transport_1.com"
...
plugin = TransportationIntegration1Plugin()
