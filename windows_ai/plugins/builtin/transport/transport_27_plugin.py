"""
Transportation Integration 27 - PRODUCTION
Transportation integration number 27
"""
...
class TransportationIntegration27Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_27",
            name="Transportation Integration 27",
            description="Transportation integration number 27",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_27_API_KEY", "")
        self.base_url = "https://api.transport_27.com"
...
plugin = TransportationIntegration27Plugin()
