"""
Transportation Integration 2 - PRODUCTION
Transportation integration number 2
"""
...
class TransportationIntegration2Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="transport_2",
            name="Transportation Integration 2",
            description="Transportation integration number 2",
            version="2.0.0",
        ...
        self.api_key = os.getenv("TRANSPORT_2_API_KEY", "")
        self.base_url = "https://api.transport_2.com"
...
plugin = TransportationIntegration2Plugin()
