...
class Plugin:
    """Plugin for Calcom integration"""
    
    def __init__(self):
        self.name = "Calcom"
        self.version = "1.0.0"
        self.description = "Calcom integration"
        
        # Configuration
        self.api_key = os.getenv("CALCOM_API_KEY", "")
        self.base_url = "https://api.calcom.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Calcom request
