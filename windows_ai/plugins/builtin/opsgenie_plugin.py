...
class Plugin:
    """Plugin for Opsgenie integration"""
    
    def __init__(self):
        self.name = "Opsgenie"
        self.version = "1.0.0"
        self.description = "Opsgenie integration"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Opsgenie"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Opsgenie"""
