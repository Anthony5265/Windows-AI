"""
Open Source Alternatives Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Open Source Alternatives local integration"""
    
    def __init__(self):
        self.name = "Open Source Alternatives"
        self.version = "1.0.0"
        self.description = "Open Source Alternatives integration"
        self.executable = "open-source-alternatives"
