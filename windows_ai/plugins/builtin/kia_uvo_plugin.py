...
class Plugin:
    """Plugin for Kia Uvo integration"""
    
    def __init__(self):
        self.name = "Kia Uvo"
        self.version = "1.0.0"
        self.description = "Kia Uvo integration"
        
        # Configuration
        self.api_key = os.getenv("KIA_UVO_API_KEY", "")
        self.base_url = "https://api.kiauvo.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Kia Uvo request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Kia Uvo"""
