...
class Plugin:
    """Plugin for Dds integration"""
    
    def __init__(self):
        self.name = "Dds"
        self.version = "1.0.0"
        self.description = "Dds integration"
        
        # Configuration
        self.api_key = os.getenv("DDS_API_KEY", "")
        self.base_url = "https://api.dds.com/v1"
        self.timeout = 30
