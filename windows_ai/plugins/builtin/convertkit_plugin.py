...
class Plugin:
    """Plugin for ConvertKit integration"""
    
    def __init__(self):
        self.name = "ConvertKit"
        self.version = "1.0.0"
        self.description = "ConvertKit email"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using ConvertKit"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using ConvertKit"""
