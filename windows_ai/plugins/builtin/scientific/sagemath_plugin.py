...
class SageMathPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="sagemath",
            name="SageMath",
            description="Math platform",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["sagemath", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("SAGEMATH_API_KEY", "")
        self.base_url = os.getenv("SAGEMATH_URL", "https://api.sagemath.com")
