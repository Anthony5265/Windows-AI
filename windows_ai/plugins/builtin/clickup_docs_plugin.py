"""
Clickup Docs Plugin - Local Tool Integration
Clickup Docs integration
"""
...
class Plugin:
    """Plugin for Clickup Docs local integration"""
    
    def __init__(self):
        self.name = "Clickup Docs"
        self.version = "1.0.0"
        self.description = "Clickup Docs integration"
        self.executable = "clickup-docs"
