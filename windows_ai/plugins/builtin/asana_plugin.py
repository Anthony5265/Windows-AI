...
class Plugin:
    """Plugin for Asana integration"""
    
    def __init__(self):
        self.name = "Asana"
        self.version = "1.0.0"
        self.description = "Asana task tracking"
        
        # Configuration
        self.api_key = os.getenv("ASANA_ACCESS_TOKEN", "")
        self.base_url = "https://app.asana.com/api/1.0"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Asana request
