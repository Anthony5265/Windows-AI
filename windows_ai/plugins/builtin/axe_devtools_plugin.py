"""
Axe Devtools Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Axe Devtools local integration"""
    
    def __init__(self):
        self.name = "Axe Devtools"
        self.version = "1.0.0"
        self.description = "Axe Devtools integration"
        self.executable = "axe-devtools"
