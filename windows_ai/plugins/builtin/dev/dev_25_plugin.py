"""
DevTools Integration 25 - PRODUCTION
DevTools integration number 25
"""
...
class DevToolsIntegration25Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="dev_25",
            name="DevTools Integration 25",
            description="DevTools integration number 25",
            version="2.0.0",
        ...
        self.api_key = os.getenv("DEV_25_API_KEY", "")
        self.base_url = "https://api.dev_25.com"
...
plugin = DevToolsIntegration25Plugin()
