"""
DevTools Integration 2 - PRODUCTION
DevTools integration number 2
"""
...
class DevToolsIntegration2Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="dev_2",
            name="DevTools Integration 2",
            description="DevTools integration number 2",
            version="2.0.0",
        ...
        self.api_key = os.getenv("DEV_2_API_KEY", "")
        self.base_url = "https://api.dev_2.com"
...
plugin = DevToolsIntegration2Plugin()
