...
class Plugin:
    """Plugin for Workday integration"""
    
    def __init__(self):
        self.name = "Workday"
        self.version = "1.0.0"
        self.description = "Workday HCM"
        
        # Configuration
        self.api_key = os.getenv("WORKDAY_TOKEN", "")
        self.base_url = "https://wd2-impl-services1.workday.com"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Workday request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Workday"""
