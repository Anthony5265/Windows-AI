"""
Social Integration 2 - PRODUCTION
Social integration number 2
"""
...
class SocialIntegration2Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="social_2",
            name="Social Integration 2",
            description="Social integration number 2",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SOCIAL_2_API_KEY", "")
        self.base_url = "https://api.social_2.com"
...
plugin = SocialIntegration2Plugin()
