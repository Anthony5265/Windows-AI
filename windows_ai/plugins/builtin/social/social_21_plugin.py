"""
Social Integration 21 - PRODUCTION
Social integration number 21
"""
...
class SocialIntegration21Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="social_21",
            name="Social Integration 21",
            description="Social integration number 21",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SOCIAL_21_API_KEY", "")
        self.base_url = "https://api.social_21.com"
...
plugin = SocialIntegration21Plugin()
