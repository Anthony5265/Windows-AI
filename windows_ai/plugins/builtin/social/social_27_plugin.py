"""
Social Integration 27 - PRODUCTION
Social integration number 27
"""
...
class SocialIntegration27Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="social_27",
            name="Social Integration 27",
            description="Social integration number 27",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SOCIAL_27_API_KEY", "")
        self.base_url = "https://api.social_27.com"
...
plugin = SocialIntegration27Plugin()
