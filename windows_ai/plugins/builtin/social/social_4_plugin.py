"""
Social Integration 4 - PRODUCTION
Social integration number 4
"""
...
class SocialIntegration4Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="social_4",
            name="Social Integration 4",
            description="Social integration number 4",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SOCIAL_4_API_KEY", "")
        self.base_url = "https://api.social_4.com"
...
plugin = SocialIntegration4Plugin()
