"""
Social Integration 36 - PRODUCTION
Social integration number 36
"""
...
class SocialIntegration36Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="social_36",
            name="Social Integration 36",
            description="Social integration number 36",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SOCIAL_36_API_KEY", "")
        self.base_url = "https://api.social_36.com"
...
plugin = SocialIntegration36Plugin()
