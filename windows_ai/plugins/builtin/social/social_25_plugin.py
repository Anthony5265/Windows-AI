"""
Social Integration 25 - PRODUCTION
Social integration number 25
"""
...
class SocialIntegration25Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="social_25",
            name="Social Integration 25",
            description="Social integration number 25",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SOCIAL_25_API_KEY", "")
        self.base_url = "https://api.social_25.com"
...
plugin = SocialIntegration25Plugin()
