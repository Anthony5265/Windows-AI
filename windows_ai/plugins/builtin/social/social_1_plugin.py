"""
Social Integration 1 - PRODUCTION
Social integration number 1
"""
...
class SocialIntegration1Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="social_1",
            name="Social Integration 1",
            description="Social integration number 1",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SOCIAL_1_API_KEY", "")
        self.base_url = "https://api.social_1.com"
...
plugin = SocialIntegration1Plugin()
