"""
Social Integration 18 - PRODUCTION
Social integration number 18
"""
...
class SocialIntegration18Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="social_18",
            name="Social Integration 18",
            description="Social integration number 18",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SOCIAL_18_API_KEY", "")
        self.base_url = "https://api.social_18.com"
...
plugin = SocialIntegration18Plugin()
