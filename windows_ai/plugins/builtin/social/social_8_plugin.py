"""
Social Integration 8 - PRODUCTION
Social integration number 8
"""
...
class SocialIntegration8Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="social_8",
            name="Social Integration 8",
            description="Social integration number 8",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SOCIAL_8_API_KEY", "")
        self.base_url = "https://api.social_8.com"
...
plugin = SocialIntegration8Plugin()
