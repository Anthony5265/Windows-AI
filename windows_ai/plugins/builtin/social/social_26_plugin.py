"""
Social Integration 26 - PRODUCTION
Social integration number 26
"""
...
class SocialIntegration26Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="social_26",
            name="Social Integration 26",
            description="Social integration number 26",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SOCIAL_26_API_KEY", "")
        self.base_url = "https://api.social_26.com"
...
plugin = SocialIntegration26Plugin()
