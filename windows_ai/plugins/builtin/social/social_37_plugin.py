"""
Social Integration 37 - PRODUCTION
Social integration number 37
"""
...
class SocialIntegration37Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="social_37",
            name="Social Integration 37",
            description="Social integration number 37",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SOCIAL_37_API_KEY", "")
        self.base_url = "https://api.social_37.com"
...
plugin = SocialIntegration37Plugin()
