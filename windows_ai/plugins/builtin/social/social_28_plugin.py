"""
Social Integration 28 - PRODUCTION
Social integration number 28
"""
...
class SocialIntegration28Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="social_28",
            name="Social Integration 28",
            description="Social integration number 28",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SOCIAL_28_API_KEY", "")
        self.base_url = "https://api.social_28.com"
...
plugin = SocialIntegration28Plugin()
