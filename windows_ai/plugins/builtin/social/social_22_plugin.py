"""
Social Integration 22 - PRODUCTION
Social integration number 22
"""
...
class SocialIntegration22Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="social_22",
            name="Social Integration 22",
            description="Social integration number 22",
            version="2.0.0",
        ...
        self.api_key = os.getenv("SOCIAL_22_API_KEY", "")
        self.base_url = "https://api.social_22.com"
...
plugin = SocialIntegration22Plugin()
