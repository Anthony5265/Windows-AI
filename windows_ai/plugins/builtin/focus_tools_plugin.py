"""
Focus Tools Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Focus Tools local integration"""
    
    def __init__(self):
        self.name = "Focus Tools"
        self.version = "1.0.0"
        self.description = "Focus Tools integration"
        self.executable = "focus-tools"
