...
class Plugin:
    """Plugin for Context Menus integration"""
    
    def __init__(self):
        self.name = "Context Menus"
        self.version = "1.0.0"
        self.description = "Context Menus integration"
        
        # Configuration
        self.api_key = os.getenv("CONTEXT_MENUS_API_KEY", "")
        self.base_url = "https://api.contextmenus.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Context Menus request
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Context Menus"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Context Menus"""
