...
class Plugin:
    """Plugin for Monday.com integration"""
    
    def __init__(self):
        self.name = "Monday.com"
        self.version = "1.0.0"
        self.description = "Monday.com work OS"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Monday.com"""
    ...
    async def _analyze(self, **kwargs) -> Dict[str, Any]:
        """Analyze content using Monday.com"""
