...
class Plugin:
    """Plugin for Coap integration"""
    
    def __init__(self):
        self.name = "Coap"
        self.version = "1.0.0"
        self.description = "Coap integration"
        
        # Configuration
        self.api_key = os.getenv("COAP_API_KEY", "")
        self.base_url = "https://api.coap.com/v1"
        self.timeout = 30
