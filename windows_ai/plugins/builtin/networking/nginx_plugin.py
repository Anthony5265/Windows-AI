"""
Nginx - Production Implementation
Web server
"""
...
class NginxPlugin(IntegrationPlugin):
    def __init__(self):
        ...
        self.api_key = os.getenv("NGINX_API_KEY", "")
        self.base_url = os.getenv("NGINX_URL", "https://api.nginx.com")
