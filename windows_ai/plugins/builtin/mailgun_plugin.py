...
class Plugin:
    """Plugin for Mailgun integration"""
    
    def __init__(self):
        self.name = "Mailgun"
        self.version = "1.0.0"
        self.description = "Mailgun email service"
    ...
    async def _generate(self, **kwargs) -> Dict[str, Any]:
        """Generate content using Mailgun"""
