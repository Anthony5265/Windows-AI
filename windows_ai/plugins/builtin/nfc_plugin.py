...
class Plugin:
    """Plugin for Nfc integration"""
    
    def __init__(self):
        self.name = "Nfc"
        self.version = "1.0.0"
        self.description = "Nfc integration"
        
        # Configuration
        self.api_key = os.getenv("NFC_API_KEY", "")
        self.base_url = "https://api.nfc.com/v1"
        self.timeout = 30
