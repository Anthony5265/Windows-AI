"""
Dwell Clicking Plugin - Local Tool Integration
Dwell Clicking integration
"""
...
class Plugin:
    """Plugin for Dwell Clicking local integration"""
    
    def __init__(self):
        self.name = "Dwell Clicking"
        self.version = "1.0.0"
        self.description = "Dwell Clicking integration"
        self.executable = "dwell-clicking"
