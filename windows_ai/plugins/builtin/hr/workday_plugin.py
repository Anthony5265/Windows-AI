"""
Workday - Production Implementation
Enterprise HR
"""
...
class WorkdayPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["workday", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("WORKDAY_API_KEY", "")
        self.base_url = os.getenv("WORKDAY_URL", "https://api.workday.com")
