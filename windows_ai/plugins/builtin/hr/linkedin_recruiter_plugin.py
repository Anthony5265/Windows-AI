"""
LinkedIn Recruiter - Production Implementation
Recruiting tool
"""
...
class LinkedInRecruiterPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["linkedin_recruiter", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("LINKEDIN_RECRUITER_API_KEY", "")
        self.base_url = os.getenv("LINKEDIN_RECRUITER_URL", "https://api.linkedin_recruiter.com")
...
plugin = LinkedInRecruiterPlugin()
