"""
HR Tool 1 - Production Implementation
HR management 1
"""
...
class HRTool1Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="hr_1",
            name="HR Tool 1",
            description="HR management 1",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["hr_1", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("HR_1_API_KEY", "")
        self.base_url = os.getenv("HR_1_URL", "https://api.hr_1.com")
