"""
Lever - Production Implementation
Talent acquisition
"""
...
class LeverPlugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["lever", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("LEVER_API_KEY", "")
        self.base_url = os.getenv("LEVER_URL", "https://api.lever.com")
    ...
    async def _posting(self, params: Dict[str, Any]) -> Dict[str, Any]:
        """Execute posting action"""
        async with self.session.post(
            f"{self.base_url}/posting",
            json=params,
            ...
            raise Exception(f"posting failed: {response.status}")
