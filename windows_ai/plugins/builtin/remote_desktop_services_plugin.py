"""
Remote Desktop Services Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Remote Desktop Services local integration"""
    
    def __init__(self):
        self.name = "Remote Desktop Services"
        self.version = "1.0.0"
        self.description = "Remote Desktop Services integration"
        self.executable = "remote-desktop-services"
