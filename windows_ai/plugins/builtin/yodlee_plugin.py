...
class Plugin:
    """Plugin for Yodlee integration"""
    
    def __init__(self):
        self.name = "Yodlee"
        self.version = "1.0.0"
        self.description = "Yodlee aggregation"
        
        # Configuration
        self.api_key = os.getenv("YODLEE_API_KEY", "")
        self.base_url = "https://api.yodlee.com/ysl"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Yodlee request
