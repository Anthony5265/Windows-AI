"""
Web3 Tools Plugin - Local Tool Integration
...
class Plugin:
    """Plugin for Web3 Tools local integration"""
    
    def __init__(self):
        self.name = "Web3 Tools"
        self.version = "1.0.0"
        self.description = "Web3 Tools integration"
        self.executable = "web3-tools"
