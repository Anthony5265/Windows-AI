"""
DataScience Integration 26 - PRODUCTION
DataScience integration number 26
"""
...
class DataScienceIntegration26Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            id="ds_26",
            name="DataScience Integration 26",
            description="DataScience integration number 26",
            version="2.0.0",
        ...
        self.api_key = os.getenv("DS_26_API_KEY", "")
        self.base_url = "https://api.ds_26.com"
...
plugin = DataScienceIntegration26Plugin()
