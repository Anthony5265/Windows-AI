"""
Prodigy Framework Integration - PRODUCTION
Annotation tool
"""
...
class ProdigyPlugin(IntegrationPlugin):
    """Prodigy framework integration"""

    def __init__(self):
        metadata = PluginMetadata(
            id="framework_prodigy",
            name="Prodigy",
            description="Annotation tool",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["framework", "ml", "ai", "prodigy"],
            requirements=["aiohttp>=3.8.0", "prodigy"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("PRODIGY_API_KEY", "")
        self.base_url = os.getenv("PRODIGY_URL", "https://api.prodigy.com")
