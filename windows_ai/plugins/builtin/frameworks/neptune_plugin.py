"""
Neptune.ai Framework Integration - PRODUCTION
Metadata store
"""
...
class NeptuneaiPlugin(IntegrationPlugin):
    """Neptune.ai framework integration"""

    def __init__(self):
        metadata = PluginMetadata(
            id="framework_neptune",
            name="Neptune.ai",
            description="Metadata store",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["framework", "ml", "ai", "neptune"],
            requirements=["aiohttp>=3.8.0", "neptune"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("NEPTUNE_API_KEY", "")
        self.base_url = os.getenv("NEPTUNE_URL", "https://api.neptune.com")
