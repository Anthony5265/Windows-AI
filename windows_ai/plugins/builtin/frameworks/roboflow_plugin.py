"""
Roboflow Framework Integration - PRODUCTION
Computer vision
"""
...
class RoboflowPlugin(IntegrationPlugin):
    """Roboflow framework integration"""

    def __init__(self):
        metadata = PluginMetadata(
            id="framework_roboflow",
            name="Roboflow",
            description="Computer vision",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["framework", "ml", "ai", "roboflow"],
            requirements=["aiohttp>=3.8.0", "roboflow"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("ROBOFLOW_API_KEY", "")
        self.base_url = os.getenv("ROBOFLOW_URL", "https://api.roboflow.com")
