"""
DSPy Framework Integration - PRODUCTION
Programming framework for LMs
"""
...
class DSPyPlugin(IntegrationPlugin):
    ...
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["framework", "ml", "ai", "dspy"],
            requirements=["aiohttp>=3.8.0", "dspy"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("DSPY_API_KEY", "")
        self.base_url = os.getenv("DSPY_URL", "https://api.dspy.com")
