"""
SuperAnnotate Framework Integration - PRODUCTION
Training data
"""
...
class SuperAnnotatePlugin(IntegrationPlugin):
    """SuperAnnotate framework integration"""

    def __init__(self):
        metadata = PluginMetadata(
            id="framework_superannotate",
            name="SuperAnnotate",
            description="Training data",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["framework", "ml", "ai", "superannotate"],
            requirements=["aiohttp>=3.8.0", "superannotate"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("SUPERANNOTATE_API_KEY", "")
        self.base_url = os.getenv("SUPERANNOTATE_URL", "https://api.superannotate.com")
