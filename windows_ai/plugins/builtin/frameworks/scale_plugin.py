"""
Scale AI Framework Integration - PRODUCTION
...
class ScaleAIPlugin(IntegrationPlugin):
    """Scale AI framework integration"""
    ...
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["framework", "ml", "ai", "scale"],
            requirements=["aiohttp>=3.8.0", "scale"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("SCALE_API_KEY", "")
        self.base_url = os.getenv("SCALE_URL", "https://api.scale.com")
