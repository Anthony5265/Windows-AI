...
class LangChainPlugin(IntegrationPlugin):
    ...
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["framework", "ml", "ai", "langchain"],
            requirements=["aiohttp>=3.8.0", "langchain"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("LANGCHAIN_API_KEY", "")
        self.base_url = os.getenv("LANGCHAIN_URL", "https://api.langchain.com")
