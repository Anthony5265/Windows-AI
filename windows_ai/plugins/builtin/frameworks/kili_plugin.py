"""
Kili Framework Integration - PRODUCTION
...
class KiliPlugin(IntegrationPlugin):
    """Kili framework integration"""
    ...
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["framework", "ml", "ai", "kili"],
            requirements=["aiohttp>=3.8.0", "kili"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("KILI_API_KEY", "")
        self.base_url = os.getenv("KILI_URL", "https://api.kili.com")
