"""
Lightly Framework Integration - PRODUCTION
Active learning
"""
...
class LightlyPlugin(IntegrationPlugin):
    """Lightly framework integration"""

    def __init__(self):
        metadata = PluginMetadata(
            id="framework_lightly",
            name="Lightly",
            description="Active learning",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["framework", "ml", "ai", "lightly"],
            requirements=["aiohttp>=3.8.0", "lightly"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("LIGHTLY_API_KEY", "")
        self.base_url = os.getenv("LIGHTLY_URL", "https://api.lightly.com")
