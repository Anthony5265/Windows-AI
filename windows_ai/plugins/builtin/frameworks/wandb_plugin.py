"""
Weights & Biases Framework Integration - PRODUCTION
...
class WeightsAndBiasesPlugin(IntegrationPlugin):
    """Weights & Biases framework integration"""
    ...
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["framework", "ml", "ai", "wandb"],
            requirements=["aiohttp>=3.8.0", "wandb"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("WANDB_API_KEY", "")
        self.base_url = os.getenv("WANDB_URL", "https://api.wandb.com")
