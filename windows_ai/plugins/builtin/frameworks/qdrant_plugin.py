"""
Qdrant Framework Integration - PRODUCTION
...
class QdrantPlugin(IntegrationPlugin):
    """Qdrant framework integration"""
    ...
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["framework", "ml", "ai", "qdrant"],
            requirements=["aiohttp>=3.8.0", "qdrant"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("QDRANT_API_KEY", "")
        self.base_url = os.getenv("QDRANT_URL", "https://api.qdrant.com")
