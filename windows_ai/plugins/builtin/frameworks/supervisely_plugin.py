"""
Supervisely Framework Integration - PRODUCTION
...
class SuperviselyPlugin(IntegrationPlugin):
    """Supervisely framework integration"""

    def __init__(self):
        metadata = PluginMetadata(
            id="framework_supervisely",
            name="Supervisely",
            description="Computer vision platform",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["framework", "ml", "ai", "supervisely"],
            requirements=["aiohttp>=3.8.0", "supervisely"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("SUPERVISELY_API_KEY", "")
        self.base_url = os.getenv("SUPERVISELY_URL", "https://api.supervisely.com")
