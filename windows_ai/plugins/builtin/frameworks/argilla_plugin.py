"""
Argilla Framework Integration - PRODUCTION
...
class ArgillaPlugin(IntegrationPlugin):
    """Argilla framework integration"""

    def __init__(self):
        metadata = PluginMetadata(
            id="framework_argilla",
            name="Argilla",
            description="Data annotation platform",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["framework", "ml", "ai", "argilla"],
            requirements=["aiohttp>=3.8.0", "argilla"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("ARGILLA_API_KEY", "")
        self.base_url = os.getenv("ARGILLA_URL", "https://api.argilla.com")
