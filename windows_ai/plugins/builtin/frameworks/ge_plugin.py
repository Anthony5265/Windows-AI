"""
Great Expectations Framework Integration - PRODUCTION
Data validation
"""
...
class GreatExpectationsPlugin(IntegrationPlugin):
    ...
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["framework", "ml", "ai", "ge"],
            requirements=["aiohttp>=3.8.0", "ge"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("GE_API_KEY", "")
        self.base_url = os.getenv("GE_URL", "https://api.ge.com")
