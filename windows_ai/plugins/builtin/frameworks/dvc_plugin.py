"""
DVC Framework Integration - PRODUCTION
...
class DVCPlugin(IntegrationPlugin):
    """DVC framework integration"""
    ...
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["framework", "ml", "ai", "dvc"],
            requirements=["aiohttp>=3.8.0", "dvc"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("DVC_API_KEY", "")
        self.base_url = os.getenv("DVC_URL", "https://api.dvc.com")
