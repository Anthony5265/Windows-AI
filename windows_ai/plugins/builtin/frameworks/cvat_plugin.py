"""
CVAT Framework Integration - PRODUCTION
...
class CVATPlugin(IntegrationPlugin):
    """CVAT framework integration"""

    def __init__(self):
        metadata = PluginMetadata(
            id="framework_cvat",
            name="CVAT",
            description="Computer vision annotation",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["framework", "ml", "ai", "cvat"],
            requirements=["aiohttp>=3.8.0", "cvat"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("CVAT_API_KEY", "")
        self.base_url = os.getenv("CVAT_URL", "https://api.cvat.com")
