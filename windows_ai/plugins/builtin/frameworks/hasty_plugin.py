"""
Hasty Framework Integration - PRODUCTION
Vision AI platform
"""
...
class HastyPlugin(IntegrationPlugin):
    """Hasty framework integration"""

    def __init__(self):
        metadata = PluginMetadata(
            id="framework_hasty",
            name="Hasty",
            description="Vision AI platform",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["framework", "ml", "ai", "hasty"],
            requirements=["aiohttp>=3.8.0", "hasty"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("HASTY_API_KEY", "")
        self.base_url = os.getenv("HASTY_URL", "https://api.hasty.com")
