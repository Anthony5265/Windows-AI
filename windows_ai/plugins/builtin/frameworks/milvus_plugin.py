"""
Milvus Framework Integration - PRODUCTION
...
class MilvusPlugin(IntegrationPlugin):
    """Milvus framework integration"""
    ...
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["framework", "ml", "ai", "milvus"],
            requirements=["aiohttp>=3.8.0", "milvus"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("MILVUS_API_KEY", "")
        self.base_url = os.getenv("MILVUS_URL", "https://api.milvus.com")
