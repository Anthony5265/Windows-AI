"""
Haystack Framework Integration - PRODUCTION
NLP framework by deepset
"""
...
class HaystackPlugin(IntegrationPlugin):
    """Haystack framework integration"""

    def __init__(self):
        metadata = PluginMetadata(
            id="framework_haystack",
            name="Haystack",
            description="NLP framework by deepset",
            version="2.0.0",
            author="Windows AI Team",
            plugin_type=PluginType.INTEGRATION,
            tags=["framework", "ml", "ai", "haystack"],
            requirements=["aiohttp>=3.8.0", "haystack"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("HAYSTACK_API_KEY", "")
        self.base_url = os.getenv("HAYSTACK_URL", "https://api.haystack.com")
