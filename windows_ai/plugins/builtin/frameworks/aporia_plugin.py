"""
Aporia Framework Integration - PRODUCTION
ML observability
"""
...
class AporiaPlugin(IntegrationPlugin):
    """Aporia framework integration"""
    ...
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["framework", "ml", "ai", "aporia"],
            requirements=["aiohttp>=3.8.0", "aporia"]
        )
        super().__init__(metadata)

        self.api_key = os.getenv("APORIA_API_KEY", "")
        self.base_url = os.getenv("APORIA_URL", "https://api.aporia.com")
