...
class Plugin:
    """Plugin for Didi integration"""
    
    def __init__(self):
        self.name = "Didi"
        self.version = "1.0.0"
        self.description = "Didi integration"
        
        # Configuration
        self.api_key = os.getenv("DIDI_API_KEY", "")
        self.base_url = "https://api.didi.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Didi request
