"""
Epic Games Store Plugin - Storage/Database integration
...
class Plugin:
    """Plugin for Epic Games Store storage"""
    
    def __init__(self):
        self.name = "Epic Games Store"
        self.version = "1.0.0"
        self.description = "Epic Games Store integration"
        self.api_key = os.getenv("EPIC_GAMES_STORE_API_KEY", "")
        self.base_url = "https://api.epicgamesstore.com"
