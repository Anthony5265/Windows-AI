"""
Metadata Filtering Plugin - Storage/Database integration
...
class Plugin:
    """Plugin for Metadata Filtering storage"""
    
    def __init__(self):
        self.name = "Metadata Filtering"
        self.version = "1.0.0"
        self.description = "Metadata Filtering integration"
        self.api_key = os.getenv("METADATA_FILTERING_API_KEY", "")
        self.base_url = "https://api.metadatafiltering.com"
