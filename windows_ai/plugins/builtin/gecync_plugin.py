...
class Plugin:
    """Plugin for Gecync integration"""
    
    def __init__(self):
        self.name = "Gecync"
        self.version = "1.0.0"
        self.description = "Gecync integration"
        
        # Configuration
        self.api_key = os.getenv("GECYNC_API_KEY", "")
        self.base_url = "https://api.gecync.com/v1"
        self.timeout = 30
    
    async def execute(self, **kwargs) -> Dict[str, Any]:
        """
        Execute Gecync request
