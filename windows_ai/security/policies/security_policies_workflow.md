# Security Policies Workflow

Create `security/policies/security_policies_workflow.md` defining workflows that operationalize policy governance.
...
This document provides comprehensive information about security policies workflow.
