...
Publish `security/policies/security_policies_baseline.md` capturing baselines that detect regressions in policy governance.
...
This document provides comprehensive information about security policies baseline.
