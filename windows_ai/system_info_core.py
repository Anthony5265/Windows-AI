"""Core system information detection utilities.

This module provides a :func:`detect_system` helper that gathers basic
hardware and software statistics about the host machine.  It is shared
between the ``windows_ai`` package and installer scripts to avoid code
duplication.
"""
