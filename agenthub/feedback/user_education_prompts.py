...
Build `agenthub/feedback/user_education_prompts.py` teaching users how to give actionable guidance.
...
*   **Upgrade 800:** Curate `docs/insights/insights_accelerator.md` accelerating experiments that push insight sharing forward.
    ...
    def __init__(self):
        """Initialize the user education prompts system."""
        self.initialized = False
        logger.info("Initialized user_education_prompts")
    ...
    def setup(self) -> bool:
        ...
        try:
            ...
            logger.info("user_education_prompts setup completed")
            return True
    ...
    def execute(self, **kwargs) -> Dict[str, Any]:
        ...
        if not self.initialized:
            raise RuntimeError("user_education_prompts not initialized. Call setup() first.")
        
        try:
            # TODO: Implement core functionality
            result = {
                "status": "success",
                "message": "user_education_prompts executed successfully",
                "data": {}
            }
            return result
        except Exception as e:
