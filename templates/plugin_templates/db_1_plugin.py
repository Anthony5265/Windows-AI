"""
Database 1 - Production Implementation
Database system 1
"""
...
class Database1Plugin(IntegrationPlugin):
    def __init__(self):
        metadata = PluginMetadata(
            ...
            tags=["db_1", "production"]
        )
        super().__init__(metadata)
        self.api_key = os.getenv("DB_1_API_KEY", "")
        self.base_url = os.getenv("DB_1_URL", "https://api.db_1.com")
