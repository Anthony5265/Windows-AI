...
Create `community/events/community_events_exchange.md` building exchanges that connect stakeholders around event programming.
...
This document provides comprehensive information about community events exchange.
