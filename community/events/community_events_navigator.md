# Community Events Navigator

Provide `community/events/community_events_navigator.md` delivering navigators that simplify event programming.
...
This document provides comprehensive information about community events navigator.
