...
Ship `community/tutorials/getting-started-with-plugins.md` onboarding plugin developers.
...
This document provides comprehensive information about getting started with plugins.
