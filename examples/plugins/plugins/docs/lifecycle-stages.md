...
Introduce `plugins/docs/lifecycle-stages.md` defining experimental, beta, and stable phases.
...
This document provides comprehensive information about lifecycle stages.
