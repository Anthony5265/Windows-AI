...
class OllamaPlatform:
    ...
    def __init__(self, models_dir: Optional[str] = None, port: int = 11434):
        """
        Initialize Ollama platform
        
        Args:
            models_dir: Directory containing models (default: ~/.ollama/models)
            port: Port for local server (default: 11434)
        """
        self.models_dir = Path(models_dir or "~/.ollama/models").expanduser()
        self.port = port
    ...
    def install(self) -> bool:
        ...
        try:
            ...
            if "ollama" == "ollama":
                ...
                print(f"Please install Ollama manually from official website")
                return False
