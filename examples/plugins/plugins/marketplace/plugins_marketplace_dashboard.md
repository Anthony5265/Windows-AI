# Plugins Marketplace Dashboard

Launch `plugins/marketplace/plugins_marketplace_dashboard.md` shipping dashboards that visualize marketplace growth.
...
This document provides comprehensive information about plugins marketplace dashboard.
