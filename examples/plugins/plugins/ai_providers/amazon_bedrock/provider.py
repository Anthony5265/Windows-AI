...
class AmazonBedrockProvider:
    ...
    Supported models: anthropic.claude-v2, amazon.titan-text, ai21.j2-ultra
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Amazon Bedrock (required)
            api_base: Base URL for API (default: https://bedrock-runtime.us-east-1.amazonaws.com)
        """
        self.api_key = api_key or os.getenv("AMAZON_BEDROCK_API_KEY")
        self.api_base = api_base or "https://bedrock-runtime.us-east-1.amazonaws.com"
        ...
        if true and not self.api_key:
            raise ValueError("API key required for Amazon Bedrock")
    ...
    def generate(self, prompt: str, model: str, **kwargs) -> Dict[str, Any]:
        """
        Generate completion from Amazon Bedrock
