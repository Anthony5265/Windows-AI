...
class RunwayProvider:
    ...
    Supported models: gen-2, gen-3-alpha
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Runway (required)
            api_base: Base URL for API (default: https://api.runwayml.com/v1)
        """
        self.api_key = api_key or os.getenv("RUNWAY_API_KEY")
        self.api_base = api_base or "https://api.runwayml.com/v1"
        ...
        if true and not self.api_key:
            raise ValueError("API key required for Runway")
    ...
    def generate(self, prompt: str, model: str, **kwargs) -> Dict[str, Any]:
        """
        Generate completion from Runway
