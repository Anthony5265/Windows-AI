...
class PerplexityProvider:
    ...
    Supported models: pplx-7b-online, pplx-70b-online, pplx-7b-chat, pplx-70b-chat
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Perplexity (required)
            api_base: Base URL for API (default: https://api.perplexity.ai)
        """
        ...
        if true and not self.api_key:
            raise ValueError("API key required for Perplexity")
