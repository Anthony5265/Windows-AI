...
class ReplicateProvider:
    ...
    Supported models: stability-ai/sdxl, meta/llama-2-70b-chat, mistralai/mixtral-8x7b
    """
    ...
    def __init__(self, api_key: Optional[str] = None, api_base: Optional[str] = None):
        ...
        Args:
            api_key: API key for Replicate (required)
            api_base: Base URL for API (default: https://api.replicate.com/v1)
        """
        self.api_key = api_key or os.getenv("REPLICATE_API_KEY")
        self.api_base = api_base or "https://api.replicate.com/v1"
    ...
    def generate(self, prompt: str, model: str, **kwargs) -> Dict[str, Any]:
        """
        Generate completion from Replicate
