...
Build `security/hardening/credential_guard_setup.md` guiding Windows Credential Guard integration.
...
This document provides comprehensive information about credential guard setup.
