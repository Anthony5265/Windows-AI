# Security Policies Exercise

Build `security/policies/security_policies_exercise.md` codifying exercises that stress-test policy governance.
...
This document provides comprehensive information about security policies exercise.
