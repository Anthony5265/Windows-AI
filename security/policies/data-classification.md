...
Add `security/policies/data-classification.md` categorizing data handled by the assistant.
...
This document provides comprehensive information about data classification.
